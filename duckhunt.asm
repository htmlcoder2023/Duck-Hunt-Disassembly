...
; Code base address: $c000
 ...
 .ineschr 1                        ; Number of 8KB CHR-ROM banks
 .inesmap 0                        ; Mapper
 .inesmir 1                        ; Mirror mode
...
_label_c056:
  lda _data_e5df_indexed,X       ; $C056  BD DF E5
  sta _var_05f0_indexed,X        ; $C059  9D F0 05
  dex                            ; $C05C  CA
...
_label_c0ba:
  ...
  ldy _var_05fc                  ; $C0C0  AC FC 05
  bne _label_c123                ; $C0C3  D0 5E
  iny                            ; $C0C5  C8
  sty _var_05fc                  ; $C0C6  8C FC 05
...
_label_c0e1:
  ...
  sta _var_0430_indexed,X        ; $C0E3  9D 30 04
  dex                            ; $C0E6  CA
...
_label_c190:
  ...
  lda _var_05fd                  ; $C194  AD FD 05
  bne _label_c1b7                ; $C197  D0 1E

_label_c199:
  ldy _var_05fe                  ; $C199  AC FE 05
  iny                            ; $C19C  C8
  cpy #$03                       ; $C19D  C0 03
...
_label_c1a3:
  sty _var_05fe                  ; $C1A3  8C FE 05
  jmp _label_c1b2                ; $C1A6  4C B2 C1

_label_c1a9:
  cmp #$00                       ; $C1A9  C9 00
  bne _label_c1b2                ; $C1AB  D0 05
  sta _var_05fd                  ; $C1AD  8D FD 05
  beq _label_c1bb                ; $C1B0  F0 09

_label_c1b2:
  lda #$01                       ; $C1B2  A9 01
  sta _var_05fd                  ; $C1B4  8D FD 05
...
_label_c1bb:
  ...
  lda #$51                       ; $C1BF  A9 51
  sta _var_0500_indexed          ; $C1C1  8D 00 05
  lda #$24                       ; $C1C4  A9 24
  ldx #$04                       ; $C1C6  A2 04

_label_c1c8:
  sta _var_0501_indexed,X        ; $C1C8  9D 01 05
  dex                            ; $C1CB  CA
  bpl _label_c1c8                ; $C1CC  10 FA
  lda _var_05fe                  ; $C1CE  AD FE 05
  asl a                          ; $C1D1  0A
  tax                            ; $C1D2  AA
  lda #$26                       ; $C1D3  A9 26
  sta _var_0501_indexed,X        ; $C1D5  9D 01 05
  ldx #$26                       ; $C1D8  A2 26
  ldy #$22                       ; $C1DA  A0 22
  jsr _func_c71d                 ; $C1DC  20 1D C7
  lda _var_05fe                  ; $C1DF  AD FE 05
  asl a                          ; $C1E2  0A
  asl a                          ; $C1E3  0A
  clc                            ; $C1E4  18
  adc #$03                       ; $C1E5  69 03
...
_label_c1ea:
  lda _var_05f0_indexed,X        ; $C1EA  BD F0 05
  and #$0F                       ; $C1ED  29 0F
  sta _var_0501_indexed,Y        ; $C1EF  99 01 05
  dey                            ; $C1F2  88
  lda _var_05f0_indexed,X        ; $C1F3  BD F0 05
  lsr a                          ; $C1F6  4A
  lsr a                          ; $C1F7  4A
  lsr a                          ; $C1F8  4A
  lsr a                          ; $C1F9  4A
  sta _var_0501_indexed,Y        ; $C1FA  99 01 05
  dex                            ; $C1FD  CA
  dey                            ; $C1FE  88
  bpl _label_c1ea                ; $C1FF  10 E9
  lda _var_0501_indexed          ; $C201  AD 01 05
  bne _label_c20b                ; $C204  D0 05
  lda #$24                       ; $C206  A9 24
  sta _var_0501_indexed          ; $C208  8D 01 05

_label_c20b:
  lda #$16                       ; $C20B  A9 16
  sta _var_0500_indexed          ; $C20D  8D 00 05
  ldx #$12                       ; $C210  A2 12
  ldy #$23                       ; $C212  A0 23
...
_label_c23f:
  sta _var_0200_indexed,Y        ; $C23F  99 00 02
  iny                            ; $C242  C8
  iny                            ; $C243  C8
  iny                            ; $C244  C8
  iny                            ; $C245  C8
...
_func_c249:
  ...
  asl a                          ; $C24F  0A
  tay                            ; $C250  A8
  lda _data_e532_indexed,Y       ; $C251  B9 32 E5
  ldx _data_e533_indexed,Y       ; $C254  BE 33 E5
  ldy #$00                       ; $C257  A0 00
...
_label_c277:
  lda _var_0430_indexed,X        ; $C277  BD 30 04
...
_label_c293:
  ...
  cmp _var_0440_indexed,X        ; $C2A2  DD 40 04
  bne _label_c2b6                ; $C2A5  D0 0F
  inc _var_0442_indexed,X        ; $C2A7  FE 42 04
  ldy _var_0442_indexed,X        ; $C2AA  BC 42 04
  cpy #$05                       ; $C2AD  C0 05
...
_label_c2b6:
  sta _var_0440_indexed,X        ; $C2B6  9D 40 04

_label_c2b9:
  lda #$00                       ; $C2B9  A9 00
  sta _var_0442_indexed,X        ; $C2BB  9D 42 04
...
_label_c2f4:
  ...
  lda #$00                       ; $C2F8  A9 00
  sta _var_0560                  ; $C2FA  8D 60 05
  sta _var_0561_indexed          ; $C2FD  8D 61 05
...
_label_c3fc:
  ...
  lda #$00                       ; $C420  A9 00
  sta _var_0561_indexed,X        ; $C422  9D 61 05
  rts                            ; $C425  60
...
_func_c426:
  ...
  ldx _var_0560                  ; $C42C  AE 60 05
  lda #$00                       ; $C42F  A9 00
  sta _var_0561_indexed,X        ; $C431  9D 61 05
  pla                            ; $C434  68
  pla                            ; $C435  68
...
_func_c437:
  ...
  asl a                          ; $C43D  0A
  tax                            ; $C43E  AA
  lda <_var_0004                 ; $C43F  A5 04
  beq _label_c46a                ; $C441  F0 27
  lda <_var_00c3_indexed,X       ; $C443  B5 C3
...
_label_c49c:
  ...
  lda <_var_00c3_indexed,X       ; $C49E  B5 C3
  eor #$FF                       ; $C4A0  49 FF

_label_c4a2:
  sta <_var_00c3_indexed,X       ; $C4A2  95 C3
  sec                            ; $C4A4  38
  lda #$00                       ; $C4A5  A9 00
...
_label_c526:
  lda _var_00c3_indexed,Y        ; $C526  B9 C3 00
...
_label_c52f:
  ...
  lda _var_00c3_indexed,Y        ; $C550  B9 C3 00
...
_label_c580:
  lda _var_00c3_indexed,Y        ; $C580  B9 C3 00
...
_func_c588:
  lda _var_05ec                  ; $C588  AD EC 05
  and #$02                       ; $C58B  29 02
  sta <_var_0007                 ; $C58D  85 07
  lda _var_05ed                  ; $C58F  AD ED 05
  and #$02                       ; $C592  29 02
...
_label_c59a:
  ror _var_05ec                  ; $C59A  6E EC 05
  ror _var_05ed                  ; $C59D  6E ED 05
  ror _var_05ee                  ; $C5A0  6E EE 05
  ror _var_05ef                  ; $C5A3  6E EF 05
  lda _var_05ec                  ; $C5A6  AD EC 05
  rts                            ; $C5A9  60
...
_func_c5f7:
  sty <_var_00a2                 ; $C5F7  84 A2
  ldx #$00                       ; $C5F9  A2 00

_label_c5fb:
  lda _var_0300_indexed,Y        ; $C5FB  B9 00 03
...
_func_c607:
  ldy <_var_00a2                 ; $C607  A4 A2
  ldx #$00                       ; $C609  A2 00

_label_c60b:
  lda <_var_0030_indexed,X       ; $C60B  B5 30
  sta _var_0300_indexed,Y        ; $C60D  99 00 03
  iny                            ; $C610  C8
  inx                            ; $C611  E8
  cpx #$50                       ; $C612  E0 50
...
_func_c62e:
  stx <_var_001e                 ; $C62E  86 1E
  sta <_var_002d                 ; $C630  85 2D
  lda #$12                       ; $C632  A9 12
  sta <_var_0025                 ; $C634  85 25
  rts                            ; $C636  60
...
_label_c63a:
  sta _var_0300_indexed,Y        ; $C63A  99 00 03
  iny                            ; $C63D  C8
...
_label_c659:
  lda <_var_00c3_indexed,X       ; $C659  B5 C3
  and #$0F                       ; $C65B  29 0F
  sta _var_0501_indexed,Y        ; $C65D  99 01 05
  dey                            ; $C660  88
  lda <_var_00c3_indexed,X       ; $C661  B5 C3
  lsr a                          ; $C663  4A
  lsr a                          ; $C664  4A
  lsr a                          ; $C665  4A
  lsr a                          ; $C666  4A
  sta _var_0501_indexed,Y        ; $C667  99 01 05
  dex                            ; $C66A  CA
  dey                            ; $C66B  88
  bpl _label_c659                ; $C66C  10 EB
  lda #$16                       ; $C66E  A9 16
  sta _var_0500_indexed          ; $C670  8D 00 05
  ldx _data_e5dc                 ; $C673  AE DC E5
  ldy _data_e5db                 ; $C676  AC DB E5
...
_label_c67c:
  ...
  asl a                          ; $C67E  0A
  tay                            ; $C67F  A8
  lda _data_eb30_indexed,Y       ; $C680  B9 30 EB
  sta <_var_0010_indexed         ; $C683  85 10
  lda _data_eb31_indexed,Y       ; $C685  B9 31 EB
  sta <_var_0011                 ; $C688  85 11
  ldy #$00                       ; $C68A  A0 00
  ldx #$00                       ; $C68C  A2 00
...
_label_c69e:
  ...
  sta _var_0200_indexed,X        ; $C6AB  9D 00 02
  inx                            ; $C6AE  E8
  lda #$56                       ; $C6AF  A9 56
  sta _var_0200_indexed,X        ; $C6B1  9D 00 02
  inx                            ; $C6B4  E8
  lda #$00                       ; $C6B5  A9 00
  sta _var_0200_indexed,X        ; $C6B7  9D 00 02
  inx                            ; $C6BA  E8
  lda <_var_000e                 ; $C6BB  A5 0E
  sta _var_0200_indexed,X        ; $C6BD  9D 00 02
  inx                            ; $C6C0  E8
...
_label_c6da:
  ...
  lda _var_03f0_indexed,X        ; $C6DC  BD F0 03
  beq _label_c6e2                ; $C6DF  F0 01
  dey                            ; $C6E1  88

_label_c6e2:
  tya                            ; $C6E2  98
  sta _var_0501_indexed,X        ; $C6E3  9D 01 05
  dex                            ; $C6E6  CA
  bpl _label_c6da                ; $C6E7  10 F1

_label_c6e9:
  lda #$1A                       ; $C6E9  A9 1A
  sta _var_0500_indexed          ; $C6EB  8D 00 05
  ldx #$4C                       ; $C6EE  A2 4C
  ldy #$23                       ; $C6F0  A0 23
...
_label_c70c:
  sta _var_0501_indexed,Y        ; $C70C  99 01 05
  iny                            ; $C70F  C8
  cpy #$03                       ; $C710  C0 03
  bne _label_c701                ; $C712  D0 ED
  lda #$13                       ; $C714  A9 13
  sta _var_0500_indexed          ; $C716  8D 00 05
  ldx #$43                       ; $C719  A2 43
  ldy #$23                       ; $C71B  A0 23
...
_label_c74c:
  lda _var_05f0_indexed,Y        ; $C74C  B9 F0 05
...
_label_c762:
  ...
  sta _var_05f0_indexed,Y        ; $C764  99 F0 05
  iny                            ; $C767  C8
  inx                            ; $C768  E8
  cpx #$04                       ; $C769  E0 04
...
_label_c7a1:
  sta _var_0500_indexed,X        ; $C7A1  9D 00 05
  dex                            ; $C7A4  CA
  bne _label_c795                ; $C7A5  D0 EE
  lda #$1A                       ; $C7A7  A9 1A
  sta _var_0500_indexed          ; $C7A9  8D 00 05
  ldx #$6C                       ; $C7AC  A2 6C
  ldy #$23                       ; $C7AE  A0 23
...
_label_c7ce:
  ...
  lsr a                          ; $C7DB  4A
  lsr a                          ; $C7DC  4A
  sta _var_0501_indexed,X        ; $C7DD  9D 01 05
  inx                            ; $C7E0  E8
...
_func_c7fb:
  ...
  lda _data_ec1f_indexed,Y       ; $C803  B9 1F EC
  cmp #$AA                       ; $C806  C9 AA
  beq _label_c818                ; $C808  F0 0E
  pha                            ; $C80A  48
  iny                            ; $C80B  C8
  lda _data_ec1f_indexed,Y       ; $C80C  B9 1F EC
...
_func_c890:
  lda _var_0300_indexed          ; $C890  AD 00 03
...
_label_c8c4:
  ...
  lda _var_0301_indexed          ; $C8CB  AD 01 03
...
_label_c91b:
  lda _data_e5eb_indexed,X       ; $C91B  BD EB E5
  ...
  lda #$40                       ; $C927  A9 40
  sta <_var_0036                 ; $C929  85 36
  lda #$7F                       ; $C92B  A9 7F
  sta <_var_0037                 ; $C92D  85 37
...
_label_c958:
  sta <_var_009c                 ; $C958  85 9C
  asl a                          ; $C95A  0A
  tax                            ; $C95B  AA
  lda _data_e60b_indexed,X       ; $C95C  BD 0B E6
  sta <_var_0044_indexed         ; $C95F  85 44
  lda _data_e60c_indexed,X       ; $C961  BD 0C E6
  sta <_var_0045                 ; $C964  85 45
  jsr _func_c588                 ; $C966  20 88 C5
  and #$3F                       ; $C969  29 3F
  tay                            ; $C96B  A8
  iny                            ; $C96C  C8
  sty <_var_00a6                 ; $C96D  84 A6
  ldy #$00                       ; $C96F  A0 00
  lda [_var_0044_indexed],Y      ; $C971  B1 44
  iny                            ; $C973  C8
  sty <_var_0047                 ; $C974  84 47
  sta <_var_0033                 ; $C976  85 33
  ldy #$00                       ; $C978  A0 00
  ldx <_var_0099                 ; $C97A  A6 99
  beq _label_c980                ; $C97C  F0 02
  ldy #$02                       ; $C97E  A0 02

_label_c980:
  sty <_var_003c                 ; $C980  84 3C
  inc <_var_0099                 ; $C982  E6 99
  ldx <_var_0098                 ; $C984  A6 98
  lda _data_e766_indexed,X       ; $C986  BD 66 E7
  cpy #$00                       ; $C989  C0 00
...
_label_c9b2:
  tax                            ; $C9B2  AA
  lda _data_e75a_indexed,X       ; $C9B3  BD 5A E7
...
_label_c9b9:
  ...
  dex                            ; $C9C1  CA
  txa                            ; $C9C2  8A
  sta <_var_000c                 ; $C9C3  85 0C
  asl a                          ; $C9C5  0A
  clc                            ; $C9C6  18
  adc <_var_000c                 ; $C9C7  65 0C

_label_c9c9:
  clc                            ; $C9C9  18
  adc <_var_003f                 ; $C9CA  65 3F
  tax                            ; $C9CC  AA
  lda _data_e73c_indexed,X       ; $C9CD  BD 3C E7
...
_label_c9e2:
  sta <_var_003a                 ; $C9E2  85 3A
  lda #$00                       ; $C9E4  A9 00
  sta <_var_0046                 ; $C9E6  85 46
  sta <_var_0042_indexed         ; $C9E8  85 42
  sta <_var_004e                 ; $C9EA  85 4E
  sta <$4F                       ; $C9EC  85 4F
  lda #$01                       ; $C9EE  A9 01
  sta <_var_004b                 ; $C9F0  85 4B
...
_label_ca08:
  sta <_var_004c                 ; $CA08  85 4C
  lda #$00                       ; $CA0A  A9 00
  sta <_var_00af                 ; $CA0C  85 AF

_label_ca0e:
  inc <_var_00bb                 ; $CA0E  E6 BB
  lda <_var_00bb                 ; $CA10  A5 BB
  sta <_var_003b                 ; $CA12  85 3B
  dec <_var_00bc                 ; $CA14  C6 BC
  inc <_var_0031                 ; $CA16  E6 31
  rts                            ; $CA18  60

_label_ca19:
  lda <_var_002f                 ; $CA19  A5 2F
  and #$07                       ; $CA1B  29 07
  bne _label_ca22                ; $CA1D  D0 03
  jsr _func_d4ee                 ; $CA1F  20 EE D4

_label_ca22:
  lda <_var_009f                 ; $CA22  A5 9F
  bne _label_ca29                ; $CA24  D0 03
  jsr _func_d52c                 ; $CA26  20 2C D5

_label_ca29:
  lda <_var_00ba                 ; $CA29  A5 BA
  bne _label_ca3e                ; $CA2B  D0 11
  lda <_var_004e                 ; $CA2D  A5 4E
  bne _label_ca3e                ; $CA2F  D0 0D
  lda #$01                       ; $CA31  A9 01
  sta <_var_004e                 ; $CA33  85 4E
  lda #$F0                       ; $CA35  A9 F0
  sta <_var_0046                 ; $CA37  85 46
  lda #$00                       ; $CA39  A9 00
  jmp _label_cb77                ; $CA3B  4C 77 CB

_label_ca3e:
  lda <_var_001f                 ; $CA3E  A5 1F
...
_label_ca45:
  lda <_var_004b                 ; $CA45  A5 4B
  beq _label_ca53                ; $CA47  F0 0A
  lda <_var_0032                 ; $CA49  A5 32
  cmp #$88                       ; $CA4B  C9 88
  bcs _label_ca42                ; $CA4D  B0 F3
  lda #$00                       ; $CA4F  A9 00
  sta <_var_004b                 ; $CA51  85 4B

_label_ca53:
  ldx #$01                       ; $CA53  A2 01
  lda <_var_004c                 ; $CA55  A5 4C
  beq _label_ca70                ; $CA57  F0 17
  lda <_var_00ba                 ; $CA59  A5 BA
  bne _label_ca66                ; $CA5B  D0 09
  sta <_var_004c                 ; $CA5D  85 4C
...
_label_ca66:
  dex                            ; $CA66  CA
  lda <_var_002f                 ; $CA67  A5 2F
  lsr a                          ; $CA69  4A
  bcc _label_ca70                ; $CA6A  90 04
  dec <_var_004c                 ; $CA6C  C6 4C
  beq _label_ca5f                ; $CA6E  F0 EF

_label_ca70:
  stx <_var_00ae                 ; $CA70  86 AE
  cpx #$01                       ; $CA72  E0 01
  beq _label_ca8a                ; $CA74  F0 14
  lda <_var_0016_indexed         ; $CA76  A5 16
  and #$0F                       ; $CA78  29 0F
  ...
  lda #$00                       ; $CA82  A9 00
  sta <_var_00af                 ; $CA84  85 AF
  lda <_var_00ae                 ; $CA86  A5 AE
...
_label_caa8:
  cmp <_var_00af                 ; $CAA8  C5 AF
  beq _label_ca8a                ; $CAAA  F0 DE
  sta <_var_00af                 ; $CAAC  85 AF
  ldx #$35                       ; $CAAE  A2 35
  lsr a                          ; $CAB0  4A
...
_label_cad1:
  inc <_var_0032                 ; $CAD1  E6 32
  ldy #$00                       ; $CAD3  A0 00
  beq _label_cadb                ; $CAD5  F0 04

_label_cad7:
  dec <_var_0032                 ; $CAD7  C6 32
  ldy #$02                       ; $CAD9  A0 02

_label_cadb:
  lda <_var_0048                 ; $CADB  A5 48
  and #$08                       ; $CADD  29 08
  tax                            ; $CADF  AA
  jmp _label_caed                ; $CAE0  4C ED CA

_label_cae3:
  inc <_var_0033                 ; $CAE3  E6 33
  ldy #$04                       ; $CAE5  A0 04
  bne _label_caed                ; $CAE7  D0 04

_label_cae9:
  dec <_var_0033                 ; $CAE9  C6 33
  ldy #$02                       ; $CAEB  A0 02

_label_caed:
  stx <_var_000c                 ; $CAED  86 0C
  sty <_var_000f                 ; $CAEF  84 0F
  lda <_var_0048                 ; $CAF1  A5 48
  and #$07                       ; $CAF3  29 07
  eor #$07                       ; $CAF5  49 07
  ora <_var_000c                 ; $CAF7  05 0C

_data_caf9:
  sta <_var_000c                 ; $CAF9  85 0C
...
_label_cb06:
  clc                            ; $CB06  18
  adc <_var_000c                 ; $CB07  65 0C
  sta <_var_000e                 ; $CB09  85 0E
  ldy <_var_000f                 ; $CB0B  A4 0F
  cmp #$00                       ; $CB0D  C9 00
...
_label_cb4b:
  dec <_var_000e                 ; $CB4B  C6 0E
  jmp _label_cb52                ; $CB4D  4C 52 CB

_label_cb50:
  inc <_var_000e                 ; $CB50  E6 0E

_label_cb52:
  lda <_var_000e                 ; $CB52  A5 0E
  and #$0F                       ; $CB54  29 0F
...
_label_cb59:
  lda <_var_0046                 ; $CB59  A5 46
  bne _label_cbc3                ; $CB5B  D0 66
  ldy <_var_0047                 ; $CB5D  A4 47
  ...
  iny                            ; $CB68  C8
  sta <_var_0031                 ; $CB69  85 31
  lda [_var_0044_indexed],Y      ; $CB6B  B1 44
  sta <_var_0042_indexed         ; $CB6D  85 42
  rts                            ; $CB6F  60

_label_cb70:
  sta <_var_0046                 ; $CB70  85 46
  lda [_var_0044_indexed],Y      ; $CB72  B1 44
  iny                            ; $CB74  C8
  sty <_var_0047                 ; $CB75  84 47

_label_cb77:
  sta <_var_0048                 ; $CB77  85 48
  tax                            ; $CB79  AA
  lda _data_e64b_indexed,X       ; $CB7A  BD 4B E6
  sta <_var_0049                 ; $CB7D  85 49
  sta <_var_004a                 ; $CB7F  85 4A
  lda #$00                       ; $CB81  A9 00
  sta <_var_0034                 ; $CB83  85 34
  lda <_var_0048                 ; $CB85  A5 48
  cmp #$11                       ; $CB87  C9 11
...
_label_cbd1:
  lda <_var_0046                 ; $CBD1  A5 46
  beq _label_cbd7                ; $CBD3  F0 02
  dec <_var_0046                 ; $CBD5  C6 46

_label_cbd7:
  ldy <_var_0049                 ; $CBD7  A4 49

_label_cbd9:
  lda _data_e661_indexed,Y       ; $CBD9  B9 61 E6
  iny                            ; $CBDC  C8
  cmp #$AA                       ; $CBDD  C9 AA
  bne _label_cbe6                ; $CBDF  D0 05
  ldy <_var_004a                 ; $CBE1  A4 4A
  jmp _label_cbd9                ; $CBE3  4C D9 CB

_label_cbe6:
  clc                            ; $CBE6  18
  adc <_var_0032                 ; $CBE7  65 32
  ldx <_var_004b                 ; $CBE9  A6 4B
  bne _label_cbf9                ; $CBEB  D0 0C
  ldx <_var_00ae                 ; $CBED  A6 AE
...
_label_cbf9:
  sta <_var_0032                 ; $CBF9  85 32

_label_cbfb:
  lda _data_e661_indexed,Y       ; $CBFB  B9 61 E6
  iny                            ; $CBFE  C8
  sty <_var_0049                 ; $CBFF  84 49
  clc                            ; $CC01  18
  adc <_var_0033                 ; $CC02  65 33
  ldx <_var_004b                 ; $CC04  A6 4B
  bne _label_cc14                ; $CC06  D0 0C
  ldx <_var_00ae                 ; $CC08  A6 AE
...
_label_cc1f:
  ldx <_var_003b                 ; $CC1F  A6 3B
  lda #$01                       ; $CC21  A9 01
  sta _var_03ef_indexed,X        ; $CC23  9D EF 03
  lda #$01                       ; $CC26  A9 01
  sta <_var_00ad                 ; $CC28  85 AD
  sta <_var_005e                 ; $CC2A  85 5E
  lda #$12                       ; $CC2C  A9 12
  sta <_var_004d                 ; $CC2E  85 4D
...
_label_cc37:
  ...
  inc <_var_0031                 ; $CC3A  E6 31
  rts                            ; $CC3C  60

_label_cc3d:
  lda <_var_004d                 ; $CC3D  A5 4D
  beq _label_cc4c                ; $CC3F  F0 0B
  dec <_var_004d                 ; $CC41  C6 4D
  and #$0F                       ; $CC43  29 0F
  cmp #$0A                       ; $CC45  C9 0A
...
_label_cc64:
  stx $03A3                      ; $CC64  8E A3 03
  lda #$01                       ; $CC67  A9 01
  sta <_var_004b                 ; $CC69  85 4B
  ldx #$10                       ; $CC6B  A2 10
  stx <_var_0048                 ; $CC6D  86 48
  lda _data_e64b_indexed,X       ; $CC6F  BD 4B E6
  sta <_var_0049                 ; $CC72  85 49
  sta <_var_004a                 ; $CC74  85 4A
  ldx #$18                       ; $CC76  A2 18
  ldy #$E7                       ; $CC78  A0 E7
  bne _label_cc37                ; $CC7A  D0 BB

_label_cc7c:
  lda <_var_0032                 ; $CC7C  A5 32
  cmp #$B0                       ; $CC7E  C9 B0
...
_label_cc85:
  ...
  inc <_var_0031                 ; $CC88  E6 31
  rts                            ; $CC8A  60

_label_cc8b:
  lda #$00                       ; $CC8B  A9 00
  sta <_var_0031                 ; $CC8D  85 31
  ldx <_var_0036                 ; $CC8F  A6 36
...
_label_ccd6:
  lda _data_e76e_indexed,X       ; $CCD6  BD 6E E7
  sta <_var_0030_indexed,X       ; $CCD9  95 30
  dex                            ; $CCDB  CA
  bpl _label_ccd6                ; $CCDC  10 F8
  lda #$03                       ; $CCDE  A9 03
  sta <_var_00ba                 ; $CCE0  85 BA
  lda #$01                       ; $CCE2  A9 01
  sta <_var_00be                 ; $CCE4  85 BE
  sta <_var_00ad                 ; $CCE6  85 AD
  lda #$02                       ; $CCE8  A9 02
  sta <_var_0023                 ; $CCEA  85 23
  lda <_var_0025                 ; $CCEC  A5 25
  cmp #$07                       ; $CCEE  C9 07
  bne _label_ccf7                ; $CCF0  D0 05
  lda #$10                       ; $CCF2  A9 10
  sta <_var_0031                 ; $CCF4  85 31
  rts                            ; $CCF6  60
...
_label_cd05:
  sty <_var_0033                 ; $CD05  84 33
  stx <_var_0044_indexed         ; $CD07  86 44
  lda #$01                       ; $CD09  A9 01
  sta <_var_009d                 ; $CD0B  85 9D
  jsr _func_c5d9                 ; $CD0D  20 D9 C5
  jsr _func_f56c                 ; $CD10  20 6C F5
  inc <_var_0031                 ; $CD13  E6 31
  rts                            ; $CD15  60
...
_label_cd1d:
  lda <_var_0035                 ; $CD1D  A5 35
  cmp #$0C                       ; $CD1F  C9 0C
  bne _label_cd2e                ; $CD21  D0 0B
  inc <_var_0044_indexed         ; $CD23  E6 44
  lda <_var_0044_indexed         ; $CD25  A5 44
  cmp #$20                       ; $CD27  C9 20
  bcc _label_cd2e                ; $CD29  90 03
  inc <_var_0031                 ; $CD2B  E6 31
...
_label_cd2e:
  ...
  lda <_var_0033                 ; $CD31  A5 33
  cmp <_var_0045                 ; $CD33  C5 45
  bne _label_cd2d                ; $CD35  D0 F6
  lda #$06                       ; $CD37  A9 06
  sta <_var_0031                 ; $CD39  85 31
  rts                            ; $CD3B  60

_label_cd3c:
  lda #$00                       ; $CD3C  A9 00
  sta <_var_0044_indexed         ; $CD3E  85 44
  ldx #$98                       ; $CD40  A2 98
  ldy #$E7                       ; $CD42  A0 E7

_label_cd44:
  jsr _func_cf0b                 ; $CD44  20 0B CF
  inc <_var_0031                 ; $CD47  E6 31
...
_label_cd52:
  lda #$04                       ; $CD52  A9 04
  sta <_var_009e                 ; $CD54  85 9E
  ldx #$AC                       ; $CD56  A2 AC
  ldy #$E7                       ; $CD58  A0 E7
  bne _label_cd44                ; $CD5A  D0 E8

_label_cd5c:
  dec <_var_009e                 ; $CD5C  C6 9E
  lda <_var_009e                 ; $CD5E  A5 9E
  bne _label_cd69                ; $CD60  D0 07
  lda #$10                       ; $CD62  A9 10
  sta <_var_009e                 ; $CD64  85 9E
...
_label_cd6c:
  lda <_var_002b_indexed         ; $CD6C  A5 2B
  bne _label_cd2d                ; $CD6E  D0 BD
  jsr _func_d4fa                 ; $CD70  20 FA D4
  lda #$80                       ; $CD73  A9 80
  sta <_var_0033                 ; $CD75  85 33
...
_label_cd9a:
  lda #$30                       ; $CD9A  A9 30
  sta <_var_00a6                 ; $CD9C  85 A6
  lda #$01                       ; $CD9E  A9 01
  sta <_var_00b9                 ; $CDA0  85 B9
  lda #$03                       ; $CDA2  A9 03
  sta <_var_00ba                 ; $CDA4  85 BA
  lda #$01                       ; $CDA6  A9 01
  sta <_var_00be                 ; $CDA8  85 BE
  lda #$00                       ; $CDAA  A9 00
  sta <_var_00bd                 ; $CDAC  85 BD
  lda #$02                       ; $CDAE  A9 02
  ldy #$01                       ; $CDB0  A0 01
  ldx <_var_001f                 ; $CDB2  A6 1F
...
_label_cdba:
  ...
  lda #$01                       ; $CDC2  A9 01
  sta _var_0300_indexed          ; $CDC4  8D 00 03
  sta _var_0301_indexed          ; $CDC7  8D 01 03
...
_label_cdd9:
  and <_var_000c                 ; $CDD9  25 0C
  sta <_var_0098                 ; $CDDB  85 98
  ldy #$00                       ; $CDDD  A0 00
  sty <_var_0099                 ; $CDDF  84 99
  tax                            ; $CDE1  AA
  lda _data_e766_indexed,X       ; $CDE2  BD 66 E7
  sta <_var_000c                 ; $CDE5  85 0C
  and #$F0                       ; $CDE7  29 F0
  lsr a                          ; $CDE9  4A
  ldy #$00                       ; $CDEA  A0 00
  jsr _func_cf44                 ; $CDEC  20 44 CF
  lda <_var_000c                 ; $CDEF  A5 0C
  and #$0F                       ; $CDF1  29 0F
  asl a                          ; $CDF3  0A
  asl a                          ; $CDF4  0A
  asl a                          ; $CDF5  0A
  ...
  lda #$3F                       ; $CDF9  A9 3F
  sta $0400                      ; $CDFB  8D 00 04
  lda #$10                       ; $CDFE  A9 10
  sta $0401                      ; $CE00  8D 01 04
  sta $0402                      ; $CE03  8D 02 04
  lda #$00                       ; $CE06  A9 00
  sta $0413                      ; $CE08  8D 13 04
  lda #$01                       ; $CE0B  A9 01
  sta <_var_0027                 ; $CE0D  85 27
  lda #$12                       ; $CE0F  A9 12
  sta <_var_0031                 ; $CE11  85 31
  lda #$00                       ; $CE13  A9 00
  sta <_var_0042_indexed         ; $CE15  85 42
  rts                            ; $CE17  60

_label_ce18:
  lda <_var_00bb                 ; $CE18  A5 BB
  cmp #$0A                       ; $CE1A  C9 0A
  bne _label_ce29                ; $CE1C  D0 0B
  lda #$00                       ; $CE1E  A9 00
  sta <_var_00a9                 ; $CE20  85 A9
  lda #$04                       ; $CE22  A9 04
  sta <_var_0025                 ; $CE24  85 25
  jmp _func_c23b                 ; $CE26  4C 3B C2

_label_ce29:
  lda #$0E                       ; $CE29  A9 0E
  sta <_var_0031                 ; $CE2B  85 31
  rts                            ; $CE2D  60

_label_ce2e:
  lda #$80                       ; $CE2E  A9 80
  sta <_var_0033                 ; $CE30  85 33
  lda #$01                       ; $CE32  A9 01
  sta <_var_0038                 ; $CE34  85 38
...
_label_ce40:
  lda <_var_0042_indexed         ; $CE40  A5 42
  bne _func_ce4d                 ; $CE42  D0 09
  lda #$00                       ; $CE44  A9 00
  sta <_var_0031                 ; $CE46  85 31
  ldx <_var_0036                 ; $CE48  A6 36
  jmp _func_d042                 ; $CE4A  4C 42 D0

_func_ce4d:
  lda <_var_0042_indexed         ; $CE4D  A5 42
  beq _label_ce56                ; $CE4F  F0 05
  dec <_var_0042_indexed         ; $CE51  C6 42
  jmp _label_d01b                ; $CE53  4C 1B D0

_label_ce56:
  ldy <_var_0043_indexed         ; $CE56  A4 43
  lda [_var_0040_indexed],Y      ; $CE58  B1 40
  cmp #$FA                       ; $CE5A  C9 FA
  bcc _label_ce72                ; $CE5C  90 14
  inc <_var_0043_indexed         ; $CE5E  E6 43
  sec                            ; $CE60  38
  sbc #$FA                       ; $CE61  E9 FA
...
_label_ce72:
  ldy <_var_0043_indexed         ; $CE72  A4 43
  ldx <_var_00a1                 ; $CE74  A6 A1
  cpx #$02                       ; $CE76  E0 02
  bne _label_cee6                ; $CE78  D0 6C
  ldx <_var_0031                 ; $CE7A  A6 31
  cpx #$09                       ; $CE7C  E0 09
...
_label_ce8c:
  ldx <_var_0046                 ; $CE8C  A6 46
  beq _label_ce9c                ; $CE8E  F0 0C
  dec <_var_0046                 ; $CE90  C6 46
  lda <_var_0047                 ; $CE92  A5 47
  clc                            ; $CE94  18
  adc <_var_0032                 ; $CE95  65 32
  sta <_var_0032                 ; $CE97  85 32
  jmp _label_d01b                ; $CE99  4C 1B D0

_label_ce9c:
  sta <_var_0046                 ; $CE9C  85 46
  iny                            ; $CE9E  C8
...
_label_ceb5:
  clc                            ; $CEB5  18
  adc <_var_0032                 ; $CEB6  65 32
  sta <_var_0032                 ; $CEB8  85 32
  iny                            ; $CEBA  C8
  lda [_var_0040_indexed],Y      ; $CEBB  B1 40
  ldx <_var_0034                 ; $CEBD  A6 34
  beq _label_cec4                ; $CEBF  F0 03
  jsr _func_d12b                 ; $CEC1  20 2B D1

_label_cec4:
  clc                            ; $CEC4  18
  adc <_var_0033                 ; $CEC5  65 33
  sta <_var_0033                 ; $CEC7  85 33

_label_cec9:
  iny                            ; $CEC9  C8
  lda [_var_0040_indexed],Y      ; $CECA  B1 40
  sta <_var_0035                 ; $CECC  85 35
  iny                            ; $CECE  C8
  sty <_var_0043_indexed         ; $CECF  84 43
...
_label_ced4:
  ...
  lda #$02                       ; $CED8  A9 02
  ldx <_var_0034                 ; $CEDA  A6 34
  beq _label_cee1                ; $CEDC  F0 03
  jsr _func_d12b                 ; $CEDE  20 2B D1

_label_cee1:
  clc                            ; $CEE1  18
  adc <_var_0033                 ; $CEE2  65 33
  sta <_var_0033                 ; $CEE4  85 33

_label_cee6:
  lda [_var_0040_indexed],Y      ; $CEE6  B1 40
  sta <_var_0042_indexed         ; $CEE8  85 42
  jmp _label_cec9                ; $CEEA  4C C9 CE

_label_ceed:
  ldy <_var_0043_indexed         ; $CEED  A4 43
  lda [_var_0040_indexed],Y      ; $CEEF  B1 40
  sta <_var_0031                 ; $CEF1  85 31
  iny                            ; $CEF3  C8
  lda [_var_0040_indexed],Y      ; $CEF4  B1 40
  sta <_var_0042_indexed         ; $CEF6  85 42
  rts                            ; $CEF8  60
...
_label_cefb:
  sta <_var_0043_indexed         ; $CEFB  85 43
  jmp _label_ce56                ; $CEFD  4C 56 CE

_label_cf00:
  lda #$01                       ; $CF00  A9 01
  sta <_var_0038                 ; $CF02  85 38
...
_func_cf0b:
  stx <_var_0040_indexed         ; $CF0B  86 40
  sty <_var_0041_indexed         ; $CF0D  84 41
  lda #$00                       ; $CF0F  A9 00
  sta <_var_0043_indexed         ; $CF11  85 43
  sta <_var_0042_indexed         ; $CF13  85 42
  rts                            ; $CF15  60

_label_cf16:
  lda <_var_0032                 ; $CF16  A5 32
  cmp #$08                       ; $CF18  C9 08
  bcc _label_cf2a                ; $CF1A  90 0E
  cmp #$90                       ; $CF1C  C9 90
  bcs _label_cf33                ; $CF1E  B0 13
  lda <_var_0033                 ; $CF20  A5 33
  cmp #$0C                       ; $CF22  C9 0C
...
_label_cf2a:
  lda #$08                       ; $CF2A  A9 08
  sta <_var_0031                 ; $CF2C  85 31
  lda #$00                       ; $CF2E  A9 00
  sta <_var_0042_indexed         ; $CF30  85 42
  rts                            ; $CF32  60
...
_func_cf39:
  lda #$00                       ; $CF39  A9 00
  sta <_var_0046                 ; $CF3B  85 46
  sta <_var_0047                 ; $CF3D  85 47
  lda #$AC                       ; $CF3F  A9 AC
  sta <_var_0032                 ; $CF41  85 32
  rts                            ; $CF43  60

_func_cf44:
  tax                            ; $CF44  AA
  lda #$08                       ; $CF45  A9 08
  sta <_var_000d                 ; $CF47  85 0D

_label_cf49:
  lda _data_e724_indexed,X       ; $CF49  BD 24 E7
  sta _var_0403_indexed,Y        ; $CF4C  99 03 04
  inx                            ; $CF4F  E8
  iny                            ; $CF50  C8
  dec <_var_000d                 ; $CF51  C6 0D
...
_label_cf78:
  clc                            ; $CF78  18
  adc <_var_003f                 ; $CF79  65 3F
  tax                            ; $CF7B  AA
  ldy _data_ebf1_indexed,X       ; $CF7C  BC F1 EB

_label_cf7f:
  sty <_var_0039                 ; $CF7F  84 39
  lda _data_ebfa_indexed,Y       ; $CF81  B9 FA EB
  sta <_var_0006                 ; $CF84  85 06
  lda #$00                       ; $CF86  A9 00
  sta <_var_0004                 ; $CF88  85 04
  sta <_var_0005                 ; $CF8A  85 05
  sta <_var_0007                 ; $CF8C  85 07
  lda #$0F                       ; $CF8E  A9 0F
  jsr _func_c437                 ; $CF90  20 37 C4
  jmp _func_c655                 ; $CF93  4C 55 C6

_func_cf96:
  lda <_var_00bd                 ; $CF96  A5 BD
  bne _label_cfb9                ; $CF98  D0 1F
  lda #$06                       ; $CF9A  A9 06
  jsr _func_d464                 ; $CF9C  20 64 D4
  lda #$30                       ; $CF9F  A9 30
  sta <_var_002b_indexed         ; $CFA1  85 2B
  lda #$06                       ; $CFA3  A9 06
  sta <_var_0023                 ; $CFA5  85 23
  lda #$01                       ; $CFA7  A9 01
  sta <_var_0027                 ; $CFA9  85 27
  lda #$36                       ; $CFAB  A9 36
  sta _var_0403_indexed          ; $CFAD  8D 03 04
  sta $0407                      ; $CFB0  8D 07 04
  sta $040B                      ; $CFB3  8D 0B 04
  sta $040F                      ; $CFB6  8D 0F 04
...
_func_cff9:
  ldx #$00                       ; $CFF9  A2 00
  lda <_var_0080_indexed,X       ; $CFFB  B5 80
  beq _label_d001                ; $CFFD  F0 02
  ldx #$04                       ; $CFFF  A2 04

_label_d001:
  lda <_var_0032                 ; $D001  A5 32
  sec                            ; $D003  38
  sbc #$04                       ; $D004  E9 04
  sta <_var_0081_indexed,X       ; $D006  95 81
  lda <_var_0033                 ; $D008  A5 33
  sec                            ; $D00A  38
  sbc #$08                       ; $D00B  E9 08
  sta <_var_0082_indexed,X       ; $D00D  95 82
  lda <_var_0039                 ; $D00F  A5 39
  clc                            ; $D011  18
  adc #$F7                       ; $D012  69 F7
  sta <_var_0083_indexed,X       ; $D014  95 83
  lda #$30                       ; $D016  A9 30
  sta <_var_0080_indexed,X       ; $D018  95 80
  rts                            ; $D01A  60

_label_d01b:
  lda <_var_0036                 ; $D01B  A5 36
  sta <_var_00b4                 ; $D01D  85 B4
  lda <_var_0035                 ; $D01F  A5 35
  asl a                          ; $D021  0A
  tay                            ; $D022  A8
  lda #$C5                       ; $D023  A9 C5
  sta <_var_0012_indexed         ; $D025  85 12
  lda #$DA                       ; $D027  A9 DA
  sta <_var_0013                 ; $D029  85 13
  lda [_var_0012_indexed],Y      ; $D02B  B1 12
  sta <_var_0010_indexed         ; $D02D  85 10
  iny                            ; $D02F  C8
  lda [_var_0012_indexed],Y      ; $D030  B1 12
  sta <_var_0011                 ; $D032  85 11
  ldy #$00                       ; $D034  A0 00
  sty <_var_001a                 ; $D036  84 1A

_label_d038:
  ldy <_var_001a                 ; $D038  A4 1A
  lda [_var_0010_indexed],Y      ; $D03A  B1 10
  cmp #$00                       ; $D03C  C9 00
  bne _label_d050                ; $D03E  D0 10
  ldx <_var_00b4                 ; $D040  A6 B4

_func_d042:
  lda #$F4                       ; $D042  A9 F4

_label_d044:
  cpx <_var_0037                 ; $D044  E4 37
  beq _label_d04f                ; $D046  F0 07
  sta _var_0200_indexed,X        ; $D048  9D 00 02
  inx                            ; $D04B  E8
...
_label_d050:
  sta <_var_0013                 ; $D050  85 13
  iny                            ; $D052  C8
  lda [_var_0010_indexed],Y      ; $D053  B1 10
  iny                            ; $D055  C8
  sta <_var_0012_indexed         ; $D056  85 12
  lda [_var_0010_indexed],Y      ; $D058  B1 10
  iny                            ; $D05A  C8
  clc                            ; $D05B  18
  adc <_var_0032                 ; $D05C  65 32
  sta <_var_00b1                 ; $D05E  85 B1
  lda [_var_0010_indexed],Y      ; $D060  B1 10
  iny                            ; $D062  C8
  ldx <_var_0034                 ; $D063  A6 34
...
_label_d06d:
  clc                            ; $D06D  18
  adc <_var_0033                 ; $D06E  65 33
  sta <_var_00b2                 ; $D070  85 B2
  sty <_var_001a                 ; $D072  84 1A
  ldy #$00                       ; $D074  A0 00
...
_label_d08f:
  ...
  inc <_var_001b                 ; $D099  E6 1B
  inc <_var_001b                 ; $D09B  E6 1B
...
_label_d0a0:
  ...
  clc                            ; $D0A7  18
  adc <_var_003c                 ; $D0A8  65 3C
  sta <_var_00b3                 ; $D0AA  85 B3
  lda <_var_0038                 ; $D0AC  A5 38
  beq _label_d08e                ; $D0AE  F0 DE
  lda <_var_00b3                 ; $D0B0  A5 B3
  ora #$20                       ; $D0B2  09 20
  sta <_var_00b3                 ; $D0B4  85 B3
  jmp _label_d08e                ; $D0B6  4C 8E D0

_label_d0b9:
  ldx <_var_001b                 ; $D0B9  A6 1B
  lda _data_dcc0_indexed,X       ; $D0BB  BD C0 DC
  inc <_var_001b                 ; $D0BE  E6 1B
  clc                            ; $D0C0  18
  adc <_var_00b1                 ; $D0C1  65 B1
  jsr _func_d10e                 ; $D0C3  20 0E D1
  ldx <_var_00b4                 ; $D0C6  A6 B4
  sta _var_0200_indexed,X        ; $D0C8  9D 00 02
  inc <_var_00b4                 ; $D0CB  E6 B4
  lda [_var_0012_indexed],Y      ; $D0CD  B1 12
  iny                            ; $D0CF  C8
  ldx <_var_00b4                 ; $D0D0  A6 B4
  sta _var_0200_indexed,X        ; $D0D2  9D 00 02
  inc <_var_00b4                 ; $D0D5  E6 B4
  lda <_var_00b3                 ; $D0D7  A5 B3
  ldx <_var_0034                 ; $D0D9  A6 34
  beq _label_d0e9                ; $D0DB  F0 0C
  and #$BF                       ; $D0DD  29 BF
  sta <_var_000c                 ; $D0DF  85 0C
  lda <_var_00b3                 ; $D0E1  A5 B3
  and #$40                       ; $D0E3  29 40
  eor #$40                       ; $D0E5  49 40
  ora <_var_000c                 ; $D0E7  05 0C

_label_d0e9:
  ldx <_var_00b4                 ; $D0E9  A6 B4
  sta _var_0200_indexed,X        ; $D0EB  9D 00 02
  inc <_var_00b4                 ; $D0EE  E6 B4
  ldx <_var_001b                 ; $D0F0  A6 1B
  lda _data_dcc0_indexed,X       ; $D0F2  BD C0 DC
  inc <_var_001b                 ; $D0F5  E6 1B
  ldx <_var_0034                 ; $D0F7  A6 34
  beq _label_d0fe                ; $D0F9  F0 03
  jsr _func_d12b                 ; $D0FB  20 2B D1

_label_d0fe:
  clc                            ; $D0FE  18
  adc <_var_00b2                 ; $D0FF  65 B2
  jsr _func_d114                 ; $D101  20 14 D1
  ldx <_var_00b4                 ; $D104  A6 B4
  sta _var_0200_indexed,X        ; $D106  9D 00 02
  inc <_var_00b4                 ; $D109  E6 B4
  jmp _label_d08f                ; $D10B  4C 8F D0

_func_d10e:
  pha                            ; $D10E  48
  lda <_var_0032                 ; $D10F  A5 32
  jmp _label_d117                ; $D111  4C 17 D1

_func_d114:
  pha                            ; $D114  48
  lda <_var_0033                 ; $D115  A5 33

_label_d117:
  sta <_var_000f                 ; $D117  85 0F
  pla                            ; $D119  68
  pha                            ; $D11A  48
  sec                            ; $D11B  38
  sbc <_var_000f                 ; $D11C  E5 0F
...
_label_d19f:
  ...
  ldy #$00                       ; $D1A7  A0 00
  lda _var_0300_indexed          ; $D1A9  AD 00 03
  beq _label_d1b5                ; $D1AC  F0 07
  lda _var_0301_indexed          ; $D1AE  AD 01 03
  cmp #$03                       ; $D1B1  C9 03
...
_label_d246:
  ...
  stx _var_0301_indexed          ; $D250  8E 01 03
...
_func_d292:
  lda _var_0302_indexed,Y        ; $D292  B9 02 03
  sta <_var_00b1                 ; $D295  85 B1
  lda _var_0303_indexed,Y        ; $D297  B9 03 03
  sta <_var_00b2                 ; $D29A  85 B2
  lda _var_030a_indexed,Y        ; $D29C  B9 0A 03
...
_label_d2a6:
  lda _data_ec02_indexed,Y       ; $D2A6  B9 02 EC
  cmp #$FF                       ; $D2A9  C9 FF
...
_label_d2d6:
  lda #$10                       ; $D2D6  A9 10
  sta <_var_002b_indexed         ; $D2D8  85 2B
  inc <_var_00a9                 ; $D2DA  E6 A9
  rts                            ; $D2DC  60

_label_d2dd:
  lda <_var_002b_indexed         ; $D2DD  A5 2B
  bne _label_d32a                ; $D2DF  D0 49
  ldy #$00                       ; $D2E1  A0 00
  ldx #$01                       ; $D2E3  A2 01

_label_d2e5:
  lda _var_03f0_indexed,X        ; $D2E5  BD F0 03
  beq _label_d2f7                ; $D2E8  F0 0D
  lda _var_03ef_indexed,X        ; $D2EA  BD EF 03
  bne _label_d2f7                ; $D2ED  D0 08
  inc _var_03ef_indexed,X        ; $D2EF  FE EF 03
  dec _var_03f0_indexed,X        ; $D2F2  DE F0 03
  ldy #$01                       ; $D2F5  A0 01
...
_label_d33d:
  lda <_var_002b_indexed         ; $D33D  A5 2B
  bne _label_d32a                ; $D33F  D0 E9
  lda #$10                       ; $D341  A9 10
  sta <_var_002b_indexed         ; $D343  85 2B
  inc <_var_00be                 ; $D345  E6 BE
  lda <_var_00be                 ; $D347  A5 BE
  cmp #$0F                       ; $D349  C9 0F
  bne _label_d3ad                ; $D34B  D0 60
  lda <_var_00aa                 ; $D34D  A5 AA
  cmp #$0A                       ; $D34F  C9 0A
...
_label_d369:
  lda _data_ebe9_indexed,X       ; $D369  BD E9 EB
  sta <_var_0005                 ; $D36C  85 05
  sta <_var_000c                 ; $D36E  85 0C
  lda _data_ebed_indexed,X       ; $D370  BD ED EB
  sta <_var_0006                 ; $D373  85 06
  lsr a                          ; $D375  4A
  lsr a                          ; $D376  4A
  lsr a                          ; $D377  4A
  lsr a                          ; $D378  4A
  sta <_var_000d                 ; $D379  85 0D
  lda #$00                       ; $D37B  A9 00
  sta <_var_0004                 ; $D37D  85 04
  sta <_var_0007                 ; $D37F  85 07
  lda #$0F                       ; $D381  A9 0F
  jsr _func_c437                 ; $D383  20 37 C4
  jsr _func_c655                 ; $D386  20 55 C6
  lda #$03                       ; $D389  A9 03
  sta <_var_00a9                 ; $D38B  85 A9
  lda #$A0                       ; $D38D  A9 A0
  sta <_var_002b_indexed         ; $D38F  85 2B
...
_label_d3b4:
  ldx #$09                       ; $D3B4  A2 09
  lda #$D6                       ; $D3B6  A9 D6
  ldy <_var_001f                 ; $D3B8  A4 1F
  cpy #$02                       ; $D3BA  C0 02
  bne _label_d3c0                ; $D3BC  D0 02
  lda #$D4                       ; $D3BE  A9 D4

_label_d3c0:
  sta _var_0501_indexed,X        ; $D3C0  9D 01 05
  dex                            ; $D3C3  CA
  bpl _label_d3c0                ; $D3C4  10 FA
  jmp _label_c6e9                ; $D3C6  4C E9 C6

_label_d3c9:
  lda <_var_002b_indexed         ; $D3C9  A5 2B
...
_func_d3df:
  lda _var_0300_indexed,Y        ; $D3DF  B9 00 03
  beq _label_d427                ; $D3E2  F0 43
  lda _var_0301_indexed,Y        ; $D3E4  B9 01 03
  cmp #$03                       ; $D3E7  C9 03
  beq _label_d3fb                ; $D3E9  F0 10
  cmp #$08                       ; $D3EB  C9 08
  bne _label_d427                ; $D3ED  D0 38
  ldx _var_030b_indexed,Y        ; $D3EF  BE 0B 03
  lda _var_03ef_indexed,X        ; $D3F2  BD EF 03
...
_label_d413:
  stx _var_0501_indexed          ; $D413  8E 01 05
  ldx #$11                       ; $D416  A2 11
  stx _var_0500_indexed          ; $D418  8E 00 05
  lda _var_030b_indexed,Y        ; $D41B  B9 0B 03
  clc                            ; $D41E  18
  adc #$4B                       ; $D41F  69 4B
  tax                            ; $D421  AA
  ldy #$23                       ; $D422  A0 23
...
_label_d44c:
  sta _var_0501_indexed          ; $D44C  8D 01 05
  stx _var_0502                  ; $D44F  8E 02 05
  sty $0503                      ; $D452  8C 03 05
  lda #$13                       ; $D455  A9 13
  sta _var_0500_indexed          ; $D457  8D 00 05
  ldx #$63                       ; $D45A  A2 63
  ldy #$23                       ; $D45C  A0 23
...
_label_d46c:
  ...
  asl a                          ; $D470  0A
  tax                            ; $D471  AA
  lda _data_ec38_indexed,X       ; $D472  BD 38 EC
  sta <_var_0014_indexed         ; $D475  85 14
  lda _data_ec39_indexed,X       ; $D477  BD 39 EC
...
_label_d485:
  ...
  sta _var_0500_indexed,X        ; $D487  9D 00 05
  iny                            ; $D48A  C8
  inx                            ; $D48B  E8
...
_label_d4ab:
  ...
  sta $0521                      ; $D4B1  8D 21 05
  lda <_var_000d                 ; $D4B4  A5 0D
  sta $0522                      ; $D4B6  8D 22 05
...
_label_d4c0:
  sta _var_0501_indexed,X        ; $D4C0  9D 01 05
  dex                            ; $D4C3  CA
  bpl _label_d4c0                ; $D4C4  10 FA
  lda #$6B                       ; $D4C6  A9 6B
  sta _var_0500_indexed          ; $D4C8  8D 00 05
  ldx #$CB                       ; $D4CB  A2 CB
...
_label_d546:
  ora <_var_00f2                 ; $D546  05 F2
  sta <_var_00f2                 ; $D548  85 F2
  rts                            ; $D54A  60
...
_label_d593:
  lda #$01                       ; $D593  A9 01
  sta _var_0300_indexed          ; $D595  8D 00 03
  sta _var_0350                  ; $D598  8D 50 03
  sta _var_0301_indexed          ; $D59B  8D 01 03
  ...
  dex                            ; $D5A9  CA
  lda _data_ec17_indexed,X       ; $D5AA  BD 17 EC

_label_d5ad:
  sta <_var_00a8                 ; $D5AD  85 A8
  lda #$80                       ; $D5AF  A9 80
...
_func_d5ee:
  lda _var_0300_indexed          ; $D5EE  AD 00 03
...
_label_d612:
  ...
  ldx _var_0301_indexed          ; $D616  AE 01 03
...
_label_d66b:
  lda _data_e8da_indexed,X       ; $D66B  BD DA E8
  sta <_var_0030_indexed,X       ; $D66E  95 30
  dex                            ; $D670  CA
  bpl _label_d66b                ; $D671  10 F8
  lda #$01                       ; $D673  A9 01
  sta <_var_00a7                 ; $D675  85 A7
  rts                            ; $D677  60

_label_d678:
  lda <_var_00a6                 ; $D678  A5 A6
  bne _label_d6d4                ; $D67A  D0 58
  lda #$01                       ; $D67C  A9 01
  sta <_var_00b9                 ; $D67E  85 B9
  jsr _func_c588                 ; $D680  20 88 C5
  and #$3F                       ; $D683  29 3F
  tay                            ; $D685  A8
  iny                            ; $D686  C8
  sty <_var_00a6                 ; $D687  84 A6
  jsr _func_c588                 ; $D689  20 88 C5
  and #$0F                       ; $D68C  29 0F
  cmp <_var_009c                 ; $D68E  C5 9C
...
_label_d697:
  sta <_var_009c                 ; $D697  85 9C
  asl a                          ; $D699  0A
  sta <_var_000c                 ; $D69A  85 0C
  asl a                          ; $D69C  0A
  clc                            ; $D69D  18
  adc <_var_000c                 ; $D69E  65 0C
  tax                            ; $D6A0  AA
  lda _data_e968_indexed,X       ; $D6A1  BD 68 E9
  sta <_var_0044_indexed         ; $D6A4  85 44
  lda _data_e969_indexed,X       ; $D6A6  BD 69 E9
  sta <_var_0043_indexed         ; $D6A9  85 43
  lda _data_e96a_indexed,X       ; $D6AB  BD 6A E9
  sta <_var_004a                 ; $D6AE  85 4A
  lda _data_e96b_indexed,X       ; $D6B0  BD 6B E9
  sta <_var_0042_indexed         ; $D6B3  85 42
  lda _data_e96c_indexed,X       ; $D6B5  BD 6C E9
  sta <_var_0047                 ; $D6B8  85 47
  lda _data_e96d_indexed,X       ; $D6BA  BD 6D E9
  sta <_var_004c                 ; $D6BD  85 4C
  inc <_var_00bb                 ; $D6BF  E6 BB
  lda <_var_00bb                 ; $D6C1  A5 BB
  sta <_var_003b                 ; $D6C3  85 3B
  dec <_var_00bc                 ; $D6C5  C6 BC
  lda #$FF                       ; $D6C7  A9 FF
  sta <_var_005f                 ; $D6C9  85 5F
  jsr _func_d53c                 ; $D6CB  20 3C D5
  lda #$05                       ; $D6CE  A9 05
  sta <_var_0058                 ; $D6D0  85 58
  inc <_var_0031                 ; $D6D2  E6 31

_label_d6d4:
  rts                            ; $D6D4  60

_label_d6d5:
  lda <_var_0058                 ; $D6D5  A5 58
  beq _label_d6e0                ; $D6D7  F0 07
  dec <_var_0058                 ; $D6D9  C6 58
  bne _label_d6e0                ; $D6DB  D0 03
  jsr _func_d4f6                 ; $D6DD  20 F6 D4

_label_d6e0:
  lda <_var_004c                 ; $D6E0  A5 4C
  bmi _label_d6ec                ; $D6E2  30 08
  lda <_var_0049                 ; $D6E4  A5 49
  lsr a                          ; $D6E6  4A
  lsr a                          ; $D6E7  4A
  cmp #$07                       ; $D6E8  C9 07
...
_label_d6ee:
  cmp <_var_005f                 ; $D6EE  C5 5F
  beq _label_d6fd                ; $D6F0  F0 0B
  sta <_var_005f                 ; $D6F2  85 5F
  clc                            ; $D6F4  18
  adc <_var_00a8                 ; $D6F5  65 A8
  tax                            ; $D6F7  AA
  lda _data_e9c8_indexed,X       ; $D6F8  BD C8 E9
  sta <_var_005e                 ; $D6FB  85 5E
...
_label_d700:
  ...
  lda <_var_004e                 ; $D70A  A5 4E
  bmi _label_d74d                ; $D70C  30 3F
  lda <_var_0049                 ; $D70E  A5 49
  cmp #$30                       ; $D710  C9 30
  bcs _label_d74d                ; $D712  B0 39
  jsr _func_d82f                 ; $D714  20 2F D8
  lda <_var_0032                 ; $D717  A5 32
  sec                            ; $D719  38
  sbc #$40                       ; $D71A  E9 40
  sta <_var_0032                 ; $D71C  85 32
  lda <_var_0049                 ; $D71E  A5 49
  lsr a                          ; $D720  4A
  tax                            ; $D721  AA
  lda _data_e92a_indexed,X       ; $D722  BD 2A E9
  sta <_var_0035                 ; $D725  85 35
  stx <_var_000c                 ; $D727  86 0C
  sec                            ; $D729  38
  sbc #$18                       ; $D72A  E9 18
...
_label_d73e:
  clc                            ; $D73E  18
  adc <_var_000c                 ; $D73F  65 0C
  tax                            ; $D741  AA
  lda _data_e944_indexed,X       ; $D742  BD 44 E9
  sta <_var_003a                 ; $D745  85 3A
  jsr _func_d805                 ; $D747  20 05 D8
  jmp _label_d01b                ; $D74A  4C 1B D0

_label_d74d:
  lda #$08                       ; $D74D  A9 08
  sta <_var_0031                 ; $D74F  85 31
  rts                            ; $D751  60

_label_d752:
  ldx <_var_003b                 ; $D752  A6 3B
  lda #$01                       ; $D754  A9 01
  sta _var_03ef_indexed,X        ; $D756  9D EF 03
  sta <_var_00ad                 ; $D759  85 AD
  lda <_var_0056                 ; $D75B  A5 56
  asl a                          ; $D75D  0A
  asl a                          ; $D75E  0A
  tax                            ; $D75F  AA
  ldy #$00                       ; $D760  A0 00
...
_label_d762:
  lda _data_eaf2_indexed,X       ; $D762  BD F2 EA
  sta _var_0050_indexed,Y        ; $D765  99 50 00
  inx                            ; $D768  E8
  iny                            ; $D769  C8
  cpy #$04                       ; $D76A  C0 04
  bne _label_d762                ; $D76C  D0 F4
  lda #$00                       ; $D76E  A9 00
  sta <_var_0057                 ; $D770  85 57
  ldx #$00                       ; $D772  A2 00

_label_d774:
  lda <_var_0032                 ; $D774  A5 32
  jsr _func_daa5                 ; $D776  20 A5 DA
  lda <_var_0033                 ; $D779  A5 33
  ...
  ldx <_var_0036                 ; $D787  A6 36
  jsr _func_d042                 ; $D789  20 42 D0
  inc <_var_0031                 ; $D78C  E6 31
  rts                            ; $D78E  60

_label_d78f:
  jsr _func_d805                 ; $D78F  20 05 D8
  jsr _func_d93a                 ; $D792  20 3A D9
  lda <_var_0036                 ; $D795  A5 36
  sta <_var_00b4                 ; $D797  85 B4
  ldy <_var_0050_indexed         ; $D799  A4 50
  iny                            ; $D79B  C8
  beq _label_d7a7                ; $D79C  F0 09
  ldx #$00                       ; $D79E  A2 00
  ldy #$0C                       ; $D7A0  A0 0C
  lda <_var_0054                 ; $D7A2  A5 54
  jsr _func_d7ce                 ; $D7A4  20 CE D7

_label_d7a7:
  ldy <_var_0053                 ; $D7A7  A4 53
  iny                            ; $D7A9  C8
  beq _label_d7b5                ; $D7AA  F0 09
  ldx #$10                       ; $D7AC  A2 10
  ldy #$20                       ; $D7AE  A0 20
  lda <_var_0055                 ; $D7B0  A5 55
  jsr _func_d7ce                 ; $D7B2  20 CE D7

_label_d7b5:
  lda <_var_0057                 ; $D7B5  A5 57
  cmp #$02                       ; $D7B7  C9 02
...
_label_d7be:
  lda #$00                       ; $D7BE  A9 00
  sta <_var_0054                 ; $D7C0  85 54
  sta <_var_0055                 ; $D7C2  85 55
  rts                            ; $D7C4  60

_label_d7c5:
  lda #$00                       ; $D7C5  A9 00
  sta <_var_0031                 ; $D7C7  85 31
  ldx <_var_0036                 ; $D7C9  A6 36
  jmp _func_d042                 ; $D7CB  4C 42 D0

_func_d7ce:
  sta <_var_000d                 ; $D7CE  85 0D
  sty <_var_000c                 ; $D7D0  84 0C
  ldy <_var_00b4                 ; $D7D2  A4 B4

_label_d7d4:
  lda <_var_000d                 ; $D7D4  A5 0D
  bne _label_d7dc                ; $D7D6  D0 04
  lda <_var_0060_indexed,X       ; $D7D8  B5 60
...
_label_d7e0:
  sta _var_0200_indexed,Y        ; $D7E0  99 00 02
  iny                            ; $D7E3  C8
  lda _data_ea30_indexed,X       ; $D7E4  BD 30 EA
  sta _var_0200_indexed,Y        ; $D7E7  99 00 02
  iny                            ; $D7EA  C8
  inx                            ; $D7EB  E8
  lda _data_ea30_indexed,X       ; $D7EC  BD 30 EA
  sta _var_0200_indexed,Y        ; $D7EF  99 00 02
  iny                            ; $D7F2  C8
  lda <_var_0060_indexed,X       ; $D7F3  B5 60
  sta _var_0200_indexed,Y        ; $D7F5  99 00 02
  iny                            ; $D7F8  C8

_label_d7f9:
  inx                            ; $D7F9  E8
  cpx <_var_000c                 ; $D7FA  E4 0C
  bne _label_d7d4                ; $D7FC  D0 D6
  sty <_var_00b4                 ; $D7FE  84 B4
  tya                            ; $D800  98
  tax                            ; $D801  AA
  jmp _func_d042                 ; $D802  4C 42 D0

_func_d805:
  lda <_var_00a7                 ; $D805  A5 A7
  beq _label_d81a                ; $D807  F0 11
  lda #$00                       ; $D809  A9 00
  sta <_var_00a7                 ; $D80B  85 A7
  ldx <_var_0036                 ; $D80D  A6 36
  jsr _func_d042                 ; $D80F  20 42 D0
  lda #$50                       ; $D812  A9 50
  sta <_var_0036                 ; $D814  85 36
  lda #$9F                       ; $D816  A9 9F
  sta <_var_0037                 ; $D818  85 37

_label_d81a:
  rts                            ; $D81A  60

_func_d81b:
  ldx <_var_005e                 ; $D81B  A6 5E
  lda _data_ea00_indexed,X       ; $D81D  BD 00 EA
  pha                            ; $D820  48
  inx                            ; $D821  E8
  txa                            ; $D822  8A
  and #$03                       ; $D823  29 03
...
_label_d82b:
  stx <_var_005e                 ; $D82B  86 5E
  pla                            ; $D82D  68
  rts                            ; $D82E  60

_func_d82f:
  lda <_var_004d                 ; $D82F  A5 4D
  sec                            ; $D831  38
  sbc #$00                       ; $D832  E9 00
  tay                            ; $D834  A8
  lda <_var_004e                 ; $D835  A5 4E
  sbc #$10                       ; $D837  E9 10
  tax                            ; $D839  AA
  lda #$3B                       ; $D83A  A9 3B
  jsr _func_d8db                 ; $D83C  20 DB D8
  sty <_var_0014_indexed         ; $D83F  84 14
  stx <_var_0015                 ; $D841  86 15
  lda <_var_004d                 ; $D843  A5 4D
  sec                            ; $D845  38
  sbc #$00                       ; $D846  E9 00
  tay                            ; $D848  A8
  lda <_var_004e                 ; $D849  A5 4E
  sbc #$10                       ; $D84B  E9 10
  tax                            ; $D84D  AA
  lda #$E7                       ; $D84E  A9 E7
  jsr _func_d8db                 ; $D850  20 DB D8
  sty <_var_0012_indexed         ; $D853  84 12
  stx <_var_0013                 ; $D855  86 13
  lda <_var_0048                 ; $D857  A5 48
  sec                            ; $D859  38
  sbc #$00                       ; $D85A  E9 00
  tay                            ; $D85C  A8
  lda <_var_0049                 ; $D85D  A5 49
  sbc #$18                       ; $D85F  E9 18
  tax                            ; $D861  AA
  lda #$7F                       ; $D862  A9 7F
  ...
  tya                            ; $D870  98
  sec                            ; $D871  38
  sbc <_var_0014_indexed         ; $D872  E5 14
  sta <_var_0093                 ; $D874  85 93
  txa                            ; $D876  8A
  sbc <_var_0015                 ; $D877  E5 15
  cmp #$50                       ; $D879  C9 50
  ror a                          ; $D87B  6A
  sta <_var_0094                 ; $D87C  85 94
  ror <_var_0093                 ; $D87E  66 93
  ldy <_var_0091                 ; $D880  A4 91
  ldx <$92                       ; $D882  A6 92
  lda #$6C                       ; $D884  A9 6C
  jsr _func_d8db                 ; $D886  20 DB D8
  clc                            ; $D889  18
  tya                            ; $D88A  98
  adc <_var_0012_indexed         ; $D88B  65 12
  tay                            ; $D88D  A8
  txa                            ; $D88E  8A
  adc <_var_0013                 ; $D88F  65 13
  tax                            ; $D891  AA
  jsr _func_d907                 ; $D892  20 07 D9
  sbc #$00                       ; $D895  E9 00
  eor #$7F                       ; $D897  49 7F
  sta <_var_0032                 ; $D899  85 32
  lda <_var_0043_indexed         ; $D89B  A5 43
  sec                            ; $D89D  38
  sbc #$00                       ; $D89E  E9 00
  tay                            ; $D8A0  A8
  lda <_var_0044_indexed         ; $D8A1  A5 44
  sbc #$09                       ; $D8A3  E9 09
  tax                            ; $D8A5  AA
  jsr _func_d907                 ; $D8A6  20 07 D9
  eor #$80                       ; $D8A9  49 80
  sta <_var_0033                 ; $D8AB  85 33
  rts                            ; $D8AD  60
...
_label_d8b0:
  ...
  tax                            ; $D8B3  AA
  ldy #$00                       ; $D8B4  A0 00
  lda <_var_0040_indexed,X       ; $D8B6  B5 40
  bpl _label_d8bb                ; $D8B8  10 01
  dey                            ; $D8BA  88

_label_d8bb:
  clc                            ; $D8BB  18
  adc <_var_0041_indexed,X       ; $D8BC  75 41
  sta <_var_0041_indexed,X       ; $D8BE  95 41
  sta <_var_0015                 ; $D8C0  85 15
  tya                            ; $D8C2  98
  ldy #$00                       ; $D8C3  A0 00
  adc <_var_0042_indexed,X       ; $D8C5  75 42
  sta <_var_0042_indexed,X       ; $D8C7  95 42
  bpl _label_d8cc                ; $D8C9  10 01
  dey                            ; $D8CB  88

_label_d8cc:
  asl <_var_0015                 ; $D8CC  06 15
  adc <_var_0043_indexed,X       ; $D8CE  75 43
  sta <_var_0043_indexed,X       ; $D8D0  95 43
  tya                            ; $D8D2  98
  adc <_var_0044_indexed,X       ; $D8D3  75 44
  sta <_var_0044_indexed,X       ; $D8D5  95 44
  txa                            ; $D8D7  8A
  bne _label_d8b0                ; $D8D8  D0 D6
  rts                            ; $D8DA  60

_func_d8db:
  sty <_var_0010_indexed         ; $D8DB  84 10
  stx <_var_0011                 ; $D8DD  86 11
  sta <_var_0095                 ; $D8DF  85 95
  lda #$00                       ; $D8E1  A9 00
  sta <_var_0096                 ; $D8E3  85 96
  sta <_var_0097                 ; $D8E5  85 97
  ldx #$08                       ; $D8E7  A2 08

_label_d8e9:
  ror <_var_0095                 ; $D8E9  66 95
  bcc _label_d8fa                ; $D8EB  90 0D
  clc                            ; $D8ED  18
  lda <_var_0096                 ; $D8EE  A5 96
  adc <_var_0010_indexed         ; $D8F0  65 10
  sta <_var_0096                 ; $D8F2  85 96
  lda <_var_0097                 ; $D8F4  A5 97
  adc <_var_0011                 ; $D8F6  65 11
  sta <_var_0097                 ; $D8F8  85 97

_label_d8fa:
  asl a                          ; $D8FA  0A
  ror <_var_0097                 ; $D8FB  66 97
  ror <_var_0096                 ; $D8FD  66 96
  dex                            ; $D8FF  CA
  bne _label_d8e9                ; $D900  D0 E7
  ldy <_var_0096                 ; $D902  A4 96
  ldx <_var_0097                 ; $D904  A6 97
  rts                            ; $D906  60

_func_d907:
  sty <_var_0096                 ; $D907  84 96
  stx <_var_0097                 ; $D909  86 97
  lda #$00                       ; $D90B  A9 00
  sta <_var_0095                 ; $D90D  85 95
  ldx #$07                       ; $D90F  A2 07
  clc                            ; $D911  18
  lda <_var_0096                 ; $D912  A5 96
  adc <_var_0093                 ; $D914  65 93
  tay                            ; $D916  A8
  lda <_var_0097                 ; $D917  A5 97
  adc <_var_0094                 ; $D919  65 94

_label_d91b:
  bcc _label_d921                ; $D91B  90 04
  sty <_var_0096                 ; $D91D  84 96
  sta <_var_0097                 ; $D91F  85 97

_label_d921:
  rol <_var_0095                 ; $D921  26 95
  rol <_var_0096                 ; $D923  26 96
  rol <_var_0097                 ; $D925  26 97
  sec                            ; $D927  38
  lda <_var_0096                 ; $D928  A5 96
  sbc <_var_0093                 ; $D92A  E5 93
  tay                            ; $D92C  A8
  lda <_var_0097                 ; $D92D  A5 97
  sbc <_var_0094                 ; $D92F  E5 94
  dex                            ; $D931  CA
...
_label_d937:
  lda <_var_0095                 ; $D937  A5 95
  rts                            ; $D939  60

_func_d93a:
  inc <_var_0057                 ; $D93A  E6 57
  ldy <_var_0050_indexed         ; $D93C  A4 50
  cpy #$FF                       ; $D93E  C0 FF
  beq _label_d977                ; $D940  F0 35
  inc <_var_0050_indexed         ; $D942  E6 50
  lda _data_ea50_indexed,Y       ; $D944  B9 50 EA
  sta <_var_000c                 ; $D947  85 0C
  sta <_var_000f                 ; $D949  85 0F
  cmp #$AA                       ; $D94B  C9 AA
  beq _label_d9b3                ; $D94D  F0 64
  cmp #$BB                       ; $D94F  C9 BB
  beq _label_d9ba                ; $D951  F0 67
  lda <_var_0057                 ; $D953  A5 57
  cmp <$51                       ; $D955  C5 51
...
_label_d95b:
  stx <_var_000d                 ; $D95B  86 0D
  lda _data_eb22_indexed,X       ; $D95D  BD 22 EB
  sta <_var_000e                 ; $D960  85 0E
  txa                            ; $D962  8A
  asl a                          ; $D963  0A
  tax                            ; $D964  AA
  lda <_var_0060_indexed,X       ; $D965  B5 60
  beq _label_d970                ; $D967  F0 07
  lda <_var_0061_indexed,X       ; $D969  B5 61
  beq _label_d970                ; $D96B  F0 03
  jsr _func_d9f6                 ; $D96D  20 F6 D9

_label_d970:
  ldx <_var_000d                 ; $D970  A6 0D
  inx                            ; $D972  E8
  cpx #$06                       ; $D973  E0 06
  bne _label_d95b                ; $D975  D0 E4

_label_d977:
  ldy <_var_0053                 ; $D977  A4 53
  cpy #$FF                       ; $D979  C0 FF
  beq _label_d9e2                ; $D97B  F0 65
  inc <_var_0053                 ; $D97D  E6 53
  lda _data_ea8f_indexed,Y       ; $D97F  B9 8F EA
  sta <_var_000c                 ; $D982  85 0C
  cmp #$AA                       ; $D984  C9 AA
  beq _label_d9ce                ; $D986  F0 46
  cmp #$BB                       ; $D988  C9 BB
  beq _label_d9d5                ; $D98A  F0 49
  lda _data_eac2_indexed,Y       ; $D98C  B9 C2 EA
  sta <_var_000f                 ; $D98F  85 0F

_label_d991:
  ldx #$00                       ; $D991  A2 00

_label_d993:
  stx <_var_000d                 ; $D993  86 0D
  lda _data_eb28_indexed,X       ; $D995  BD 28 EB
  sta <_var_000e                 ; $D998  85 0E
  txa                            ; $D99A  8A
  asl a                          ; $D99B  0A
  clc                            ; $D99C  18
  adc #$10                       ; $D99D  69 10
  tax                            ; $D99F  AA
  lda <_var_0060_indexed,X       ; $D9A0  B5 60
  beq _label_d9ab                ; $D9A2  F0 07
  lda <_var_0061_indexed,X       ; $D9A4  B5 61
  beq _label_d9ab                ; $D9A6  F0 03
  jsr _func_d9f6                 ; $D9A8  20 F6 D9

_label_d9ab:
  ldx <_var_000d                 ; $D9AB  A6 0D
  inx                            ; $D9AD  E8
  cpx #$08                       ; $D9AE  E0 08
...
_label_d9b3:
  lda #$FF                       ; $D9B3  A9 FF
  sta <_var_0050_indexed         ; $D9B5  85 50
  jmp _label_d977                ; $D9B7  4C 77 D9

_label_d9ba:
  lda #$01                       ; $D9BA  A9 01
  sta <_var_0054                 ; $D9BC  85 54
  lda #$00                       ; $D9BE  A9 00
  sta <_var_000c                 ; $D9C0  85 0C
  sta <_var_000f                 ; $D9C2  85 0F
  jmp _label_d959                ; $D9C4  4C 59 D9

_label_d9c7:
  lda <$52                       ; $D9C7  A5 52
  sta <_var_0053                 ; $D9C9  85 53
  jmp _label_d959                ; $D9CB  4C 59 D9

_label_d9ce:
  lda #$FF                       ; $D9CE  A9 FF
  sta <_var_0053                 ; $D9D0  85 53
  jmp _label_d9e2                ; $D9D2  4C E2 D9

_label_d9d5:
  lda #$01                       ; $D9D5  A9 01
  sta <_var_0055                 ; $D9D7  85 55
  lda #$00                       ; $D9D9  A9 00
  sta <_var_000c                 ; $D9DB  85 0C
  sta <_var_000f                 ; $D9DD  85 0F
  jmp _label_d991                ; $D9DF  4C 91 D9

_label_d9e2:
  lda <_var_0050_indexed         ; $D9E2  A5 50
  cmp #$FF                       ; $D9E4  C9 FF
  bne _label_d9f5                ; $D9E6  D0 0D
  lda <_var_0053                 ; $D9E8  A5 53
  cmp #$FF                       ; $D9EA  C9 FF
  bne _label_d9f5                ; $D9EC  D0 07
  jsr _func_cff9                 ; $D9EE  20 F9 CF
  lda #$08                       ; $D9F1  A9 08
  sta <_var_0031                 ; $D9F3  85 31

_label_d9f5:
  rts                            ; $D9F5  60

_func_d9f6:
  lda <_var_0057                 ; $D9F6  A5 57
  and #$03                       ; $D9F8  29 03
  sta <_var_001b                 ; $D9FA  85 1B
  lda <_var_000e                 ; $D9FC  A5 0E
...
_func_daa5:
  clc                            ; $DAA5  18
  adc <_var_0060_indexed,X       ; $DAA6  75 60
  cmp #$07                       ; $DAA8  C9 07
...
_label_dab2:
  sta <_var_0060_indexed,X       ; $DAB2  95 60
  rts                            ; $DAB4  60

_func_dab5:
  clc                            ; $DAB5  18
  adc <_var_0061_indexed,X       ; $DAB6  75 61
  cmp #$07                       ; $DAB8  C9 07
...
_label_dac2:
  sta <_var_0061_indexed,X       ; $DAC2  95 61
  rts                            ; $DAC4  60

 .byte $0f, $db, $14, $db, $1d, $db, $26, $db, $2f, $db, $38, $db, $41, $db, $4a, $db ; $DAC5
 .byte $5b, $db, $86, $db, $6c, $db, $79, $db, $8f, $db, $9c, $db, $a9, $db, $b6, $db ; $DAD5
 .byte $c3, $db, $3a, $dc, $fa, $db, $07, $dc, $0c, $dc, $25, $dc, $d0, $db, $e5, $db ; $DAE5
 .byte $4b, $dc, $50, $dc, $61, $dc, $72, $dc, $7b, $dc, $88, $dc, $91, $dc, $9a, $dc ; $DAF5
 .byte $9f, $dc, $a8, $dc, $ad, $dc, $b6, $dc, $bb, $dc, $dd, $0c, $f0, $f0, $00, $dd ; $DB05
 .byte $24, $f0, $f0, $dd, $e1, $ef, $08, $00, $dd, $3a, $f0, $f0, $dd, $e1, $ee, $08 ; $DB15
 .byte $00, $dd, $53, $f0, $f8, $dd, $65, $f4, $f0, $00, $dd, $6f, $f0, $f8, $dd, $81 ; $DB25
 .byte $fc, $f0, $00, $dd, $8a, $f0, $f8, $dd, $9c, $04, $f0, $00, $dd, $c3, $f0, $f0 ; $DB35
 .byte $dd, $d7, $fc, $10, $00, $dd, $e6, $f8, $f8, $dd, $ef, $ff, $f0, $dd, $f4, $f7 ; $DB45
 .byte $08, $dd, $dc, $fb, $10, $00, $dd, $fa, $f8, $f8, $dd, $ef, $fe, $f0, $dd, $f4 ; $DB55
 .byte $f6, $08, $dd, $d7, $fa, $10, $00, $de, $04, $f0, $f4, $de, $12, $f4, $04, $de ; $DB65
 .byte $17, $08, $04, $00, $de, $1c, $f0, $fc, $de, $2a, $f4, $f4, $de, $2f, $08, $f4 ; $DB75
 .byte $00, $dd, $a5, $f0, $f0, $dd, $bd, $08, $fa, $00, $de, $90, $f8, $10, $de, $34 ; $DB85
 .byte $f0, $e8, $df, $ed, $e8, $ea, $00, $de, $90, $f8, $10, $de, $4b, $f0, $e8, $df ; $DB95
 .byte $f2, $e0, $f0, $00, $de, $90, $f8, $10, $de, $62, $f0, $e8, $df, $ed, $e8, $ea ; $DBA5
 .byte $00, $de, $90, $f8, $10, $de, $79, $f0, $e8, $df, $f2, $e0, $f0, $00, $de, $9a ; $DBB5
 .byte $f8, $10, $de, $34, $f0, $e8, $df, $ed, $e8, $ea, $00, $de, $a4, $f0, $f8, $de ; $DBC5
 .byte $b8, $10, $f8, $de, $c0, $ed, $f0, $de, $c6, $f0, $08, $de, $cb, $fe, $f0, $00 ; $DBD5
 .byte $de, $d3, $f0, $f8, $de, $e7, $10, $f8, $de, $ef, $ed, $f0, $de, $f5, $f0, $08 ; $DBE5
 .byte $de, $fa, $fe, $f0, $00, $df, $02, $e0, $00, $df, $0b, $f0, $10, $df, $10, $f0 ; $DBF5
 .byte $f0, $00, $df, $29, $f0, $f0, $00, $df, $3f, $ed, $f0, $df, $45, $03, $f0, $df ; $DC05
 .byte $4b, $f0, $f8, $df, $55, $10, $f8, $df, $5d, $f0, $00, $df, $80, $04, $18, $00 ; $DC15
 .byte $df, $85, $f0, $e0, $df, $5d, $f0, $00, $df, $ab, $04, $e0, $df, $b0, $04, $18 ; $DC25
 .byte $df, $55, $10, $f8, $00, $df, $b5, $e0, $00, $df, $cb, $00, $00, $df, $da, $f0 ; $DC35
 .byte $e8, $df, $f8, $e0, $f0, $00, $df, $fe, $f8, $f4, $00, $e0, $0f, $fc, $f5, $e0 ; $DC45
 .byte $14, $fc, $03, $e0, $19, $f9, $fc, $e0, $1e, $fe, $fc, $00, $e0, $0f, $fc, $f7 ; $DC55
 .byte $e0, $14, $fc, $01, $e0, $19, $fa, $fc, $e0, $1e, $fd, $fc, $00, $e0, $0f, $fc ; $DC65
 .byte $f8, $e0, $14, $fc, $00, $00, $e0, $23, $fc, $f7, $e0, $23, $fc, $f9, $e0, $28 ; $DC75
 .byte $fc, $01, $00, $e0, $23, $fc, $f8, $e0, $28, $fc, $00, $00, $e0, $23, $fc, $f9 ; $DC85
 .byte $e0, $28, $fc, $ff, $00, $e0, $2d, $fc, $fc, $00, $e0, $32, $fc, $fc, $e0, $32 ; $DC95
 .byte $fc, $fb, $00, $e0, $32, $fc, $fc, $00, $e0, $37, $fc, $fc, $e0, $37, $fc, $fd ; $DCA5
 .byte $00, $e0, $37, $fc, $fc, $00, $e0, $3c, $fc, $f8, $00 ; $DCB5

_data_dcc0_indexed:
 .byte $00, $00, $08, $00, $10, $00, $18, $00, $00, $08, $08, $08, $10, $08, $18, $08 ; $DCC0
 .byte $00, $00, $00, $08, $00, $10, $00, $18, $08, $00, $08, $08, $08, $10, $08, $18 ; $DCD0
 .byte $10, $00, $10, $08, $10, $10, $10, $18, $18, $00, $18, $08, $18, $10, $18, $18 ; $DCE0
 .byte $08, $20, $10, $20, $18, $20, $18, $20, $00, $00, $08, $00, $10, $00, $00, $08 ; $DCF0
 .byte $08, $08, $10, $08, $00, $00, $08, $00, $00, $18, $08, $18, $01, $fd, $00, $00 ; $DD00
 .byte $01, $02, $fd, $01, $03, $fd, $00, $04, $05, $06, $07, $08, $09, $0a, $fe, $fd ; $DD10
 .byte $01, $0b, $0c, $ff, $01, $fd, $00, $fe, $fe, $0d, $fe, $fd, $00, $0f, $10, $11 ; $DD20
 .byte $fe, $12, $13, $14, $15, $fd, $01, $16, $17, $ff, $01, $fd, $00, $fe, $fe, $18 ; $DD30
 .byte $fe, $fd, $00, $1a, $1b, $1c, $fe, $1d, $1e, $1f, $fe, $fd, $01, $20, $21, $fd ; $DD40
 .byte $00, $22, $ff, $00, $fd, $00, $25, $26, $27, $fd, $01, $28, $fd, $40, $25, $26 ; $DD50
 .byte $27, $fd, $41, $28, $ff, $03, $fd, $00, $23, $24, $fd, $40, $23, $24, $ff, $00 ; $DD60
 .byte $fd, $00, $2a, $2b, $2c, $fd, $01, $2d, $fd, $40, $2a, $2b, $2c, $fd, $41, $2d ; $DD70
 .byte $ff, $03, $fd, $00, $29, $fe, $fd, $40, $29, $ff, $00, $fd, $00, $2f, $30, $31 ; $DD80
 .byte $fd, $01, $32, $fd, $40, $2f, $30, $31, $fd, $41, $32, $ff, $03, $fd, $00, $2e ; $DD90
 .byte $fe, $fd, $40, $2e, $ff, $01, $fd, $00, $33, $34, $35, $fd, $01, $36, $fd, $00 ; $DDA0
 .byte $37, $38, $39, $fd, $01, $3a, $fd, $00, $fe, $3b, $3c, $3d, $ff, $01, $fd, $01 ; $DDB0
 .byte $3e, $3f, $ff, $01, $fd, $00, $fe, $40, $41, $fe, $fe, $42, $43, $44, $45, $46 ; $DDC0
 .byte $47, $48, $fe, $fd, $01, $49, $ff, $00, $fd, $01, $4a, $ff, $00, $fd, $01, $f6 ; $DDD0
 .byte $ff, $00, $fd, $01, $03, $ff, $02, $fd, $01, $9f, $a0, $a1, $a2, $a3, $ff, $00 ; $DDE0
 .byte $fd, $01, $45, $ff, $00, $fd, $00, $44, $48, $ff, $02, $fd, $01, $a4, $a5, $a6 ; $DDF0
 .byte $a7, $a8, $a9, $ff, $00, $fd, $01, $ab, $ac, $fe, $fe, $0e, $19, $aa, $fd, $80 ; $DE00
 .byte $e5, $ff, $00, $fd, $81, $ea, $ff, $00, $fd, $81, $e9, $ff, $00, $fd, $41, $0e ; $DE10
 .byte $19, $aa, $fd, $c0, $e5, $fd, $41, $ab, $ac, $ff, $00, $fd, $c1, $ea, $ff, $00 ; $DE20
 .byte $fd, $c1, $e9, $ff, $01, $fd, $03, $52, $53, $54, $fe, $55, $56, $56, $57, $5a ; $DE30
 .byte $5b, $5c, $5d, $61, $62, $63, $64, $58, $5e, $65, $ff, $01, $fd, $03, $52, $6a ; $DE40
 .byte $54, $fe, $55, $6b, $56, $57, $6c, $6d, $6e, $6f, $70, $71, $72, $73, $58, $5e ; $DE50
 .byte $74, $ff, $01, $fd, $03, $75, $53, $54, $fe, $76, $56, $56, $57, $77, $78, $79 ; $DE60
 .byte $7a, $7b, $7c, $7d, $7e, $58, $5e, $7f, $ff, $01, $fd, $03, $52, $6a, $54, $fe ; $DE70
 .byte $76, $6b, $56, $57, $80, $81, $82, $83, $85, $86, $87, $88, $58, $84, $89, $ff ; $DE80
 .byte $02, $fd, $02, $59, $5f, $66, $fe, $60, $67, $ff, $02, $fd, $02, $4b, $4c, $4d ; $DE90
 .byte $4e, $4f, $50, $ff, $00, $fd, $02, $cd, $ce, $cf, $fd, $03, $d0, $fd, $42, $cd ; $DEA0
 .byte $ce, $fd, $02, $d2, $fd, $03, $d3, $ff, $01, $fd, $03, $d1, $fd, $43, $d1, $ff ; $DEB0
 .byte $03, $fd, $02, $c9, $ca, $ff, $00, $fd, $02, $d4, $ff, $03, $fd, $03, $cb, $cc ; $DEC0
 .byte $d5, $d6, $ff, $00, $fd, $02, $d7, $d8, $d9, $fd, $03, $d0, $fd, $42, $d7, $d8 ; $DED0
 .byte $fd, $02, $da, $fd, $03, $d3, $ff, $01, $fd, $03, $d1, $fd, $43, $d1, $ff, $03 ; $DEE0
 .byte $fd, $02, $c9, $ca, $ff, $00, $fd, $02, $d4, $ff, $03, $fd, $03, $cb, $cc, $d5 ; $DEF0
 .byte $d6, $ff, $02, $fd, $03, $b3, $b4, $fe, $b9, $ba, $ff, $00, $fd, $02, $bf, $ff ; $DF00
 .byte $01, $fd, $03, $fe, $af, $b5, $fd, $02, $bb, $fd, $03, $fe, $b0, $b6, $bc, $ad ; $DF10
 .byte $b1, $b7, $bd, $ae, $b2, $b8, $be, $c0, $ff, $01, $fd, $03, $fe, $fe, $c1, $c2 ; $DF20
 .byte $c3, $c4, $c5, $c6, $ad, $b1, $b7, $c7, $ae, $b2, $b8, $be, $fe, $c8, $ff, $00 ; $DF30
 .byte $fd, $02, $c9, $ca, $ff, $00, $fd, $03, $db, $dc, $ff, $00, $fd, $02, $dd, $de ; $DF40
 .byte $fd, $03, $df, $e0, $ff, $01, $fd, $03, $d1, $fd, $43, $d1, $ff, $01, $fd, $42 ; $DF50
 .byte $dd, $fd, $02, $d4, $fd, $00, $e5, $fd, $01, $e9, $fd, $42, $de, $fd, $03, $e2 ; $DF60
 .byte $e6, $fe, $e1, $e3, $fd, $01, $e7, $fe, $fd, $43, $e0, $fd, $01, $e4, $e8, $ff ; $DF70
 .byte $00, $fd, $01, $ea, $ff, $01, $fd, $41, $e9, $fd, $40, $e5, $fd, $42, $d4, $fd ; $DF80
 .byte $02, $dd, $fe, $fd, $43, $e6, $e2, $fd, $02, $de, $fe, $fd, $41, $e7, $fd, $43 ; $DF90
 .byte $e3, $e1, $fe, $fd, $41, $e8, $e4, $fd, $03, $e0, $ff, $00, $fd, $41, $ea, $ff ; $DFA0
 .byte $00, $fd, $01, $ea, $ff, $01, $fd, $03, $8a, $8b, $fe, $fe, $8c, $fd, $02, $8d ; $DFB0
 .byte $8e, $fe, $8f, $90, $91, $92, $93, $94, $95, $96, $ff, $01, $fd, $03, $97, $fd ; $DFC0
 .byte $02, $98, $fd, $03, $99, $fe, $9a, $9b, $9c, $ff, $01, $fd, $03, $52, $53, $54 ; $DFD0
 .byte $fe, $55, $56, $56, $fe, $5a, $5b, $5c, $fe, $61, $62, $63, $ff, $01, $fd, $03 ; $DFE0
 .byte $51, $ff, $02, $fd, $03, $68, $69, $ff, $00, $fd, $03, $9d, $9e, $ff, $01, $fd ; $DFF0

 .bank 1
 .org $e000

 .byte $00, $f2, $f3, $fd, $40, $f2, $fe, $fd, $00, $f4, $f5, $fd, $40, $f4, $ff, $00 ; $E000
 .byte $fd, $00, $eb, $ff, $00, $fd, $40, $eb, $ff, $00, $fd, $00, $f3, $ff, $00, $fd ; $E010
 .byte $00, $f5, $ff, $01, $fd, $00, $ec, $ff, $01, $fd, $40, $ec, $ff, $01, $fd, $00 ; $E020
 .byte $ef, $ff, $00, $fd, $00, $f0, $ff, $00, $fd, $00, $f1, $ff, $01, $fd, $00, $ed ; $E030
 .byte $ee, $ff, $23, $00, $60, $50, $23, $20, $60, $50, $23, $40, $60, $50, $23, $60 ; $E040
 .byte $60, $50, $23, $80, $60, $50, $23, $a0, $60, $50, $22, $40, $20, $3d, $3e, $3f ; $E050
 .byte $40, $56, $57, $d1, $d2, $3a, $3b, $3c, $3d, $3e, $3f, $40, $39, $3a, $3b, $3c ; $E060
 .byte $3d, $3e, $3f, $40, $d2, $30, $31, $32, $33, $39, $3a, $3b, $3c, $22, $60, $20 ; $E070
 .byte $95, $96, $97, $98, $58, $59, $5a, $5b, $92, $93, $94, $95, $96, $97, $98, $91 ; $E080
 .byte $92, $93, $94, $95, $96, $97, $98, $5b, $34, $35, $36, $37, $91, $92, $93, $94 ; $E090
 .byte $22, $80, $20, $46, $45, $48, $46, $46, $45, $46, $48, $42, $43, $44, $46, $45 ; $E0A0
 .byte $48, $46, $41, $42, $43, $44, $46, $45, $48, $46, $48, $38, $45, $46, $46, $41 ; $E0B0
 .byte $42, $43, $44, $22, $a0, $60, $46, $22, $a4, $01, $48, $22, $a8, $01, $47, $22 ; $E0C0
 .byte $aa, $01, $48, $22, $b0, $01, $47, $22, $b2, $01, $48, $22, $ba, $01, $48, $22 ; $E0D0
 .byte $c0, $20, $4c, $4d, $4e, $4f, $49, $4a, $4b, $49, $4c, $4d, $4e, $4f, $4d, $4e ; $E0E0
 .byte $4f, $49, $4a, $4b, $49, $4c, $4d, $4e, $4f, $49, $49, $4a, $4b, $49, $4c, $4d ; $E0F0
 .byte $4e, $4f, $22, $e0, $20, $52, $50, $53, $50, $50, $51, $50, $50, $52, $50, $53 ; $E100
 .byte $50, $50, $53, $50, $50, $51, $50, $50, $52, $50, $53, $50, $50, $50, $51, $50 ; $E110
 .byte $50, $52, $50, $53, $50, $23, $00, $01, $52, $23, $02, $02, $54, $52, $23, $0a ; $E120
 .byte $02, $54, $52, $23, $0d, $02, $54, $52, $23, $0f, $02, $54, $52, $23, $15, $02 ; $E130
 .byte $54, $52, $23, $1e, $02, $54, $52, $21, $f9, $03, $28, $29, $2a, $22, $19, $03 ; $E140
 .byte $2b, $46, $2c, $22, $38, $04, $2d, $2e, $46, $2f, $20, $81, $04, $5c, $5d, $5e ; $E150
 .byte $5f, $20, $a1, $05, $60, $61, $46, $62, $63, $20, $c1, $05, $64, $65, $66, $67 ; $E160
 .byte $68, $20, $e3, $05, $69, $74, $75, $76, $6a, $21, $03, $05, $6b, $6c, $7c, $6d ; $E170
 .byte $6e, $21, $23, $05, $6f, $70, $71, $72, $73, $21, $40, $07, $74, $75, $76, $77 ; $E180
 .byte $78, $79, $7a, $21, $60, $09, $7b, $7c, $7d, $7e, $7f, $80, $5d, $5e, $5f, $21 ; $E190
 .byte $81, $09, $81, $82, $83, $84, $60, $61, $46, $62, $63, $21, $a3, $07, $85, $86 ; $E1A0
 .byte $64, $87, $88, $67, $68, $21, $c3, $04, $89, $8a, $8b, $8c, $21, $e4, $02, $8d ; $E1B0
 .byte $8e, $22, $04, $02, $8f, $90, $22, $24, $02, $8f, $55, $23, $03, $02, $1b, $27 ; $E1C0
 .byte $23, $23, $5b, $e3, $23, $22, $06, $e2, $e3, $e3, $e3, $e4, $e2, $23, $36, $02 ; $E1D0
 .byte $e4, $e2, $23, $3e, $01, $e4, $23, $48, $56, $b7, $23, $42, $06, $e5, $d9, $d9 ; $E1E0
 .byte $d9, $e7, $e5, $23, $4c, $4a, $d6, $23, $56, $02, $e7, $e5, $23, $5e, $01, $e7 ; $E1F0
 .byte $23, $58, $46, $00, $23, $68, $56, $b7, $23, $62, $06, $e5, $da, $db, $dc, $e7 ; $E200
 .byte $e5, $23, $76, $02, $e7, $e5, $23, $7e, $01, $e7, $23, $79, $05, $1c, $0c, $18 ; $E210
 .byte $1b, $0e, $23, $83, $5b, $e9, $23, $82, $01, $e8, $23, $86, $02, $ea, $e8, $23 ; $E220
 .byte $96, $02, $ea, $e8, $23, $9e, $01, $ea, $23, $c0, $60, $00, $23, $ca, $04, $cc ; $E230
 .byte $ff, $ff, $ff, $23, $d2, $04, $cc, $ff, $ff, $ff, $23, $e0, $48, $50, $23, $e1 ; $E240
 .byte $01, $40, $23, $e8, $48, $a5, $23, $f0, $08, $aa, $aa, $aa, $fa, $fa, $ba, $fa ; $E250
 .byte $ba, $23, $f8, $48, $0a, $23, $48, $03, $11, $12, $1d, $00, $22, $20, $60, $b6 ; $E260
 .byte $22, $40, $60, $b5, $22, $60, $60, $b5, $22, $80, $60, $b5, $22, $a0, $60, $b5 ; $E270
 .byte $22, $c0, $60, $b5, $22, $e0, $60, $b5, $23, $00, $60, $b5, $21, $85, $05, $ac ; $E280
 .byte $ad, $ae, $c1, $c2, $21, $a4, $07, $af, $b0, $b5, $b5, $c3, $c4, $c5, $21, $b0 ; $E290
 .byte $04, $ec, $b4, $b8, $b9, $21, $c2, $0b, $b1, $b2, $b5, $b5, $b5, $b5, $b5, $c6 ; $E2A0
 .byte $c7, $c8, $c9, $21, $ce, $0f, $ca, $b4, $b5, $b5, $b5, $ed, $ba, $bb, $bc, $b3 ; $E2B0
 .byte $eb, $b0, $be, $bb, $bf, $21, $e2, $59, $b5, $21, $e0, $02, $b3, $b4, $21, $eb ; $E2C0
 .byte $04, $cb, $c4, $cc, $cd, $21, $f5, $01, $bd, $21, $fb, $05, $bd, $cb, $c4, $c8 ; $E2D0
 .byte $bb, $22, $00, $5d, $b5, $22, $0d, $03, $ce, $cf, $d0, $22, $1d, $03, $c3, $c0 ; $E2E0
 .byte $c0, $22, $60, $06, $99, $9a, $9b, $9c, $99, $9a, $22, $80, $06, $9d, $9e, $9f ; $E2F0
 .byte $a0, $9d, $9e, $22, $a0, $06, $a1, $a2, $a3, $a4, $a1, $a2, $22, $c0, $06, $a5 ; $E300
 .byte $a6, $a5, $a7, $a5, $a6, $22, $47, $84, $9b, $9f, $a3, $a5, $22, $48, $84, $9c ; $E310
 .byte $a0, $a4, $a6, $22, $4a, $02, $a8, $a9, $22, $6a, $02, $aa, $ab, $22, $58, $05 ; $E320
 .byte $a8, $a9, $a8, $a8, $a8, $22, $77, $06, $a8, $aa, $ab, $aa, $aa, $aa, $22, $74 ; $E330
 .byte $82, $a9, $ab, $22, $97, $01, $aa, $22, $ba, $04, $99, $9a, $9b, $9c, $22, $da ; $E340
 .byte $04, $9d, $9e, $9f, $a0, $22, $fa, $04, $a1, $a2, $a3, $a4, $23, $20, $60, $c0 ; $E350
 .byte $23, $40, $60, $c0, $23, $60, $60, $c0, $23, $80, $60, $c0, $23, $a0, $60, $c0 ; $E360
 .byte $23, $00, $60, $dd, $23, $08, $50, $df, $23, $07, $01, $de, $23, $18, $01, $e0 ; $E370
 .byte $23, $28, $56, $e3, $23, $48, $56, $b7, $23, $68, $56, $b7, $23, $88, $56, $e9 ; $E380
 .byte $23, $58, $46, $00, $23, $22, $06, $e2, $e3, $e3, $e3, $e4, $e2, $23, $42, $06 ; $E390
 .byte $e5, $d9, $d9, $d9, $e7, $e5, $23, $62, $06, $e5, $da, $db, $dc, $e7, $e5, $23 ; $E3A0
 .byte $82, $06, $e8, $e9, $e9, $e9, $ea, $e8, $23, $4c, $4a, $d4, $23, $03, $02, $1b ; $E3B0
 .byte $27, $23, $36, $84, $e4, $e7, $e7, $ea, $23, $37, $84, $e2, $e5, $e5, $e8, $23 ; $E3C0
 .byte $3e, $84, $e4, $e7, $e7, $ea, $23, $79, $05, $1c, $0c, $18, $1b, $0e, $23, $c0 ; $E3D0
 .byte $60, $00, $23, $c8, $50, $ff, $23, $e0, $48, $50, $23, $e8, $48, $55, $23, $f0 ; $E3E0
 .byte $08, $aa, $aa, $aa, $fa, $fa, $ba, $fa, $ba, $23, $f8, $48, $0a, $23, $48, $03 ; $E3F0
 .byte $11, $12, $1d, $00, $20, $64, $53, $b7, $20, $84, $53, $b7, $20, $a4, $53, $b7 ; $E400
 .byte $20, $c4, $53, $b7, $20, $e4, $53, $b7, $20, $86, $82, $f5, $f4, $20, $67, $85 ; $E410
 .byte $f0, $b7, $b7, $b7, $f1, $20, $68, $c5, $24, $20, $6b, $83, $24, $24, $f4, $20 ; $E420
 .byte $e9, $04, $f3, $b7, $b7, $f1, $20, $6d, $c5, $24, $20, $6e, $04, $f2, $b7, $b7 ; $E430
 .byte $f0, $20, $ee, $04, $f3, $b7, $b7, $f1, $20, $90, $02, $f5, $f6, $20, $b0, $02 ; $E440
 .byte $f4, $f7, $20, $72, $c5, $24, $20, $75, $85, $24, $f8, $b7, $f9, $24, $20, $96 ; $E450
 .byte $82, $f1, $f0, $21, $24, $58, $fb, $21, $49, $53, $b7, $21, $69, $52, $b7, $21 ; $E460
 .byte $89, $52, $b7, $21, $a9, $52, $b7, $21, $c9, $52, $b7, $21, $4b, $85, $24, $fa ; $E470
 .byte $b7, $24, $24, $21, $4d, $c5, $24, $21, $ce, $04, $f3, $b7, $b7, $f1, $21, $50 ; $E480
 .byte $83, $24, $24, $f4, $21, $52, $c5, $24, $21, $55, $85, $24, $f0, $b7, $f9, $24 ; $E490
 .byte $21, $57, $c5, $24, $21, $78, $c4, $24, $21, $7b, $c4, $24, $22, $28, $0f, $10 ; $E4A0
 .byte $0a, $16, $0e, $24, $0a, $24, $24, $24, $01, $24, $0d, $1e, $0c, $14, $22, $68 ; $E4B0
 .byte $10, $10, $0a, $16, $0e, $24, $0b, $24, $24, $24, $02, $24, $0d, $1e, $0c, $14 ; $E4C0
 .byte $1c, $22, $a8, $16, $10, $0a, $16, $0e, $24, $0c, $24, $24, $24, $0c, $15, $0a ; $E4D0
 .byte $22, $24, $1c, $11, $18, $18, $1d, $12, $17, $10, $23, $07, $0b, $1d, $18, $19 ; $E4E0
 .byte $24, $1c, $0c, $18, $1b, $0e, $24, $27, $23, $45, $16, $25, $01, $09, $08, $04 ; $E4F0
 .byte $24, $17, $12, $17, $1d, $0e, $17, $0d, $18, $24, $0c, $18, $ee, $15, $1d, $0d ; $E500
 .byte $ef, $23, $c0, $60, $00, $23, $e0, $42, $55, $23, $e2, $46, $ff, $23, $ea, $46 ; $E510
 .byte $ff, $23, $f0, $48, $5a, $23, $f8, $48, $00, $23, $e1, $01, $55, $23, $e9, $01 ; $E520
 .byte $55, $00                  ; $E530
...
_data_e533_indexed:
 ...
 .byte $0f, $29, $18, $21, $0f, $30, $16, $00 ; $E5D3
...
_data_e60c_indexed:
 .byte $ed, $98, $ed, $b0, $ed, $bc, $ed, $d4, $ed, $fa, $ed, $1a, $ee, $34, $ee, $4c ; $E60C
 .byte $ee, $68, $ee, $82, $ee, $96, $ee, $b8, $ee, $d0, $ee, $f4, $ee, $0e, $ef, $2a ; $E61C
 .byte $ef, $2d, $ef, $30, $ef, $33, $ef, $36, $ef, $39, $ef, $3c, $ef, $3f, $ef, $42 ; $E62C
 .byte $ef, $45, $ef, $48, $ef, $4b, $ef, $4e, $ef, $51, $ef, $54, $ef, $57, $ef ; $E63C

_data_e64b_indexed:
 .byte $00, $03, $10, $17, $24, $27, $34, $3b, $48, $4b, $58, $5f, $6c, $6f, $7c, $83 ; $E64B
 .byte $90, $95, $98, $9b, $9e, $a1 ; $E65B

_data_e661_indexed:
 .byte $ff, $00, $aa, $ff, $01, $ff, $00, $ff, $00, $ff, $01, $ff, $00, $00, $00, $aa ; $E661
 .byte $ff, $01, $ff, $01, $00, $00, $aa, $00, $01, $ff, $01, $00, $01, $ff, $01, $00 ; $E671
 .byte $01, $00, $00, $aa, $00, $01, $aa, $00, $01, $01, $01, $00, $01, $01, $01, $00 ; $E681
 .byte $01, $00, $00, $aa, $01, $01, $01, $01, $00, $00, $aa, $01, $01, $01, $00, $01 ; $E691
 .byte $00, $01, $01, $01, $00, $00, $00, $aa, $01, $00, $aa, $01, $ff, $01, $00, $01 ; $E6A1
 .byte $00, $01, $ff, $01, $00, $00, $00, $aa, $01, $ff, $01, $ff, $00, $00, $aa, $00 ; $E6B1
 .byte $ff, $01, $ff, $00, $ff, $01, $ff, $00, $ff, $00, $00, $aa, $00, $ff, $aa, $00 ; $E6C1
 .byte $ff, $ff, $ff, $00, $ff, $ff, $ff, $00, $ff, $00, $00, $aa, $ff, $ff, $ff, $ff ; $E6D1
 .byte $00, $00, $aa, $ff, $ff, $ff, $00, $ff, $00, $ff, $ff, $ff, $00, $00, $00, $aa ; $E6E1
 .byte $02, $01, $02, $ff, $aa, $ff, $fe, $aa, $fe, $ff, $aa, $fe, $00, $aa, $fe, $01 ; $E6F1
 .byte $aa, $ff, $02, $aa, $02, $00, $02, $01, $04, $02, $fe, $02, $03, $02, $04, $04 ; $E701
 .byte $05, $fe, $14, $09, $ff, $06, $01, $04, $0a, $04, $0b, $fe, $02, $06, $02, $07 ; $E711
 .byte $04, $08, $fe             ; $E721

_data_e724_indexed:
 .byte $21, $30, $0a, $0f, $21, $30, $26, $0f, $21, $30, $14, $02, $21, $30, $26, $02 ; $E724
 .byte $21, $30, $0f, $05, $21, $30, $26, $05 ; $E734

_data_e73c_indexed:
 .byte $04, $08, $0c, $08, $0c, $10, $08, $0c, $10, $0c, $10, $14, $10, $14, $18, $10 ; $E73C
 .byte $14, $18, $14, $18, $1c, $14, $1c, $1c, $18, $1c, $1c, $1c, $1c, $20 ; $E74C

_data_e75a_indexed:
 .byte $10, $14, $14, $18, $18, $1c, $1c, $20, $20, $24, $24, $28 ; $E75A

_data_e766_indexed:
 .byte $00, $01, $10, $11, $12, $20, $21, $22 ; $E766

_data_e76e_indexed:
 .byte $01, $01, $ac, $18, $00, $00, $00, $bf, $00, $00, $00, $00, $00, $00, $00, $00 ; $E76E
 .byte $00, $00, $00, $00, $00, $60, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; $E77E
 .byte $06, $0c, $06, $0d, $06, $0e, $06, $0f, $fe, $00, $08, $0c, $08, $10, $08, $0c ; $E78E
 .byte $08, $10, $08, $0c, $08, $10, $ff, $02, $01, $10, $11, $ff, $08, $01, $90, $03 ; $E79E
 .byte $12, $83, $01, $12, $83, $01, $12, $83, $01, $12, $83, $01, $12, $82, $01, $12 ; $E7AE
 .byte $82, $01, $12, $82, $01, $12, $82, $01, $12, $81, $01, $12, $82, $01, $12, $81 ; $E7BE
 .byte $01, $12, $81, $01, $12, $81, $01, $12, $81, $01, $12, $81, $01, $12, $81, $01 ; $E7CE
 .byte $12, $84, $01, $13, $00, $01, $13, $81, $01, $13, $00, $01, $13, $81, $01, $13 ; $E7DE
 .byte $00, $01, $13, $00, $01, $13, $00, $01, $13, $81, $01, $13, $fd, $00, $01, $13 ; $E7EE
 .byte $00, $01, $13, $00, $01, $13, $00, $01, $13, $01, $01, $13, $00, $01, $13, $01 ; $E7FE
 .byte $01, $13, $00, $01, $13, $01, $01, $13, $01, $01, $13, $01, $01, $13, $02, $01 ; $E80E
 .byte $13, $02, $01, $13, $02, $01, $13, $03, $01, $13, $03, $01, $13, $04, $00, $13 ; $E81E
 .byte $04, $00, $13, $05, $00, $13, $05, $00, $13, $05, $00, $13, $05, $00, $13, $05 ; $E82E
 .byte $00, $13, $05, $00, $13, $ff, $0e, $00, $04, $81, $16, $04, $81, $17, $04, $81 ; $E83E
 .byte $16, $04, $81, $17, $04, $81, $16, $04, $81, $17, $04, $81, $16, $04, $81, $17 ; $E84E
 .byte $04, $81, $16, $04, $81, $17, $04, $80, $16, $04, $80, $17, $04, $80, $16, $04 ; $E85E
 .byte $80, $17, $04, $80, $16, $04, $80, $17, $04, $80, $16, $04, $80, $17, $04, $02 ; $E86E
 .byte $16, $04, $02, $17, $04, $02, $16, $04, $02, $17, $04, $02, $16, $04, $02, $17 ; $E87E
 .byte $04, $02, $16, $ff, $0f, $20, $14, $82, $14, $10, $00, $14, $14, $02, $14, $14 ; $E88E
 .byte $02, $14, $ff, $0f, $20, $14, $82, $15, $10, $00, $15, $14, $02, $15, $14, $02 ; $E89E
 .byte $15, $ff, $0f, $20, $04, $81, $16, $04, $81, $17, $04, $81, $16, $04, $81, $17 ; $E8AE
 .byte $04, $81, $16, $04, $81, $17, $04, $81, $16, $04, $81, $17, $04, $81, $16, $04 ; $E8BE
 .byte $81, $17, $04, $80, $16, $04, $80, $17, $04, $80, $16, $fc ; $E8CE

_data_e8da_indexed:
 .byte $01, $02, $00, $00, $00, $00, $00, $4f, $00, $00, $00, $00, $00, $00, $00, $01 ; $E8DA
 .byte $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $02, $00 ; $E8EA
 .byte $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; $E8FA
 .byte $f9, $fe, $fb, $fe, $ff, $fe, $ff, $fa, $fb, $fa, $f9, $fa, $00, $00, $00, $00 ; $E90A
 .byte $fa, $fd, $fb, $fd, $fb, $fd, $fc, $fd, $fc, $fb, $fb, $fb, $fb, $fb, $fa, $fb ; $E91A

_data_e92a_indexed:
 .byte $18, $18, $19, $1a, $1a, $1b, $1c, $1d, $1e, $1e, $1f, $1f, $20, $20, $21, $21 ; $E92A
 .byte $22, $22, $22, $22, $23, $23, $23, $23, $23, $23 ; $E93A

_data_e944_indexed:
 .byte $00, $00, $00, $01, $01, $01, $02, $02, $02, $02, $03, $03, $03, $03, $04, $04 ; $E944
 .byte $04, $04, $04, $05, $05, $05, $05, $05, $05, $05, $05, $05, $05, $05, $05, $05 ; $E954
 .byte $05, $05, $05, $05        ; $E964
...
_data_e96d_indexed:
 .byte $2c, $01, $00, $c0, $0a, $1e, $30, $03, $00, $d0, $10, $1e, $25, $04, $00, $c0 ; $E96D
 .byte $00, $1c, $30, $06, $00, $c0, $0f, $1c, $30, $08, $00, $c0, $f6, $1c, $30, $09 ; $E97D
 .byte $00, $c0, $0c, $1c, $30, $0a, $00, $c0, $f4, $1c, $30, $0c, $00, $c0, $f4, $1e ; $E98D
 .byte $2d, $0e, $00, $c0, $08, $1c, $30, $0a, $00, $c0, $00, $1d, $30, $11, $00, $b8 ; $E99D
 .byte $ee, $20, $33, $13, $00, $c8, $f0, $1c, $2a, $04, $80, $c8, $f7, $1c, $2d, $0a ; $E9AD
 .byte $80, $c8, $0b, $1c, $2d, $0f, $80, $c6, $f3, $21, $26 ; $E9BD

_data_e9c8_indexed:
 .byte $14, $14, $10, $10, $10, $08, $04, $00, $18, $14, $14, $10, $0c, $08, $04, $00 ; $E9C8
 .byte $1c, $18, $18, $14, $10, $0c, $08, $04, $20, $1c, $18, $14, $10, $0c, $08, $04 ; $E9D8
 .byte $24, $20, $1c, $18, $14, $0c, $08, $04, $28, $24, $20, $1c, $14, $10, $0c, $08 ; $E9E8
 .byte $2c, $28, $24, $20, $18, $10, $0c, $08 ; $E9F8

_data_ea00_indexed:
 .byte $01, $01, $01, $01, $02, $01, $01, $01, $02, $01, $02, $01, $02, $02, $02, $01 ; $EA00
 .byte $02, $02, $02, $02, $03, $02, $03, $02, $03, $03, $03, $03, $04, $03, $04, $03 ; $EA10
 .byte $04, $04, $04, $04, $05, $05, $05, $05, $06, $06, $06, $06, $07, $07, $07, $07 ; $EA20

_data_ea30_indexed:
 .byte $ed, $40, $ed, $40, $ed, $c0, $ed, $80, $ed, $00, $ed, $00, $ed, $00, $ed, $00 ; $EA30
 .byte $ee, $40, $ee, $40, $ee, $40, $ee, $40, $ee, $00, $ee, $00, $ee, $00, $ee, $00 ; $EA40

_data_ea50_indexed:
 .byte $06, $05, $04, $03, $03, $02, $03, $03, $02, $02, $02, $02, $02, $01, $01, $02 ; $EA50
 .byte $01, $01, $01, $01, $01, $01, $01, $00, $01, $01, $01, $01, $00, $01, $01, $01 ; $EA60
 .byte $00, $01, $01, $00, $01, $00, $01, $00, $bb, $01, $00, $01, $00, $bb, $01, $00 ; $EA70
 .byte $01, $00, $bb, $01, $00, $01, $bb, $00, $01, $bb, $00, $00, $bb, $00, $aa ; $EA80

_data_ea8f_indexed:
 .byte $02, $02, $01, $02, $02, $01, $01, $01, $01, $01, $00, $01, $00, $01, $00, $01 ; $EA8F
 .byte $00, $01, $bb, $00, $00, $01, $bb, $00, $00, $01, $bb, $00, $00, $bb, $01, $00 ; $EA9F
 .byte $00, $bb, $01, $00, $bb, $00, $00, $bb, $bb, $bb, $bb, $bb, $bb, $bb, $bb, $bb ; $EAAF
 .byte $bb, $bb, $aa             ; $EABF

_data_eac2_indexed:
 .byte $01, $01, $00, $01, $01, $01, $00, $01, $00, $01, $00, $00, $01, $00, $00, $00 ; $EAC2
 .byte $00, $01, $00, $00, $00, $00, $00, $01, $00, $00, $00, $00, $00, $00, $01, $00 ; $EAD2
 .byte $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; $EAE2

_data_eaf2_indexed:
 .byte $00, $06, $00, $ff, $02, $05, $02, $ff, $08, $04, $06, $ff, $0e, $04, $07, $ff ; $EAF2
 .byte $12, $05, $08, $ff, $14, $04, $0a, $ff, $ff, $00, $00, $02, $ff, $00, $00, $04 ; $EB02
 .byte $ff, $00, $00, $06, $ff, $00, $00, $0a, $ff, $00, $00, $10, $ff, $00, $00, $14 ; $EB12

_data_eb22_indexed:
 .byte $02, $04, $06, $0a, $0c, $0e ; $EB22

_data_eb28_indexed:
 .byte $01, $03, $05, $07, $09, $0b, $0d, $0f ; $EB28
...
_data_eb31_indexed:
 ...
 .byte $f8, $fe, $00, $02, $f8, $02, $00, $aa ; $EBE1

_data_ebe9_indexed:
 .byte $01, $01, $02, $03        ; $EBE9

_data_ebed_indexed:
 .byte $00, $50, $00, $00        ; $EBED

_data_ebf1_indexed:
 .byte $00, $02, $03, $01, $04, $06, $02, $05, $07 ; $EBF1

_data_ebfa_indexed:
 .byte $05, $08, $10, $15, $16, $20, $24, $30 ; $EBFA
...
_func_f383:
  ...
  lda _data_f846_indexed,Y       ; $F385  B9 46 F8
  tay                            ; $F388  A8
  lda _data_f846_indexed,Y       ; $F389  B9 46 F8
  sta <_var_00e5                 ; $F38C  85 E5
  lda _data_f847_indexed,Y       ; $F38E  B9 47 F8
  sta <_var_00f8_indexed         ; $F391  85 F8
  lda _data_f847_indexed+1,Y     ; $F393  B9 48 F8
  sta <_var_00f9_indexed         ; $F396  85 F9
  lda _data_f849_indexed,Y       ; $F398  B9 49 F8
  sta <_var_00fa_indexed         ; $F39B  85 FA
  lda _data_f849_indexed+1,Y     ; $F39D  B9 4A F8
  sta <_var_00fb                 ; $F3A0  85 FB
  lda _data_f84b_indexed,Y       ; $F3A2  B9 4B F8
  sta <_var_00fc_indexed         ; $F3A5  85 FC
  lda _data_f84b_indexed+1,Y     ; $F3A7  B9 4C F8
  sta <_var_00fd                 ; $F3AA  85 FD
  lda _data_f84d_indexed,Y       ; $F3AC  B9 4D F8
  sta <_var_00fe_indexed         ; $F3AF  85 FE
  lda _data_f84d_indexed+1,Y     ; $F3B1  B9 4E F8
...
_data_f3e1_indexed:
 ...
 .byte $40, $c0, $b2, $df, $ff, $80, $02, $7f, $0f, $08, $00, $7f, $03, $08, $ff ; $F3F1
...
_data_f402_indexed:
 .byte $18, $10, $01, $18, $00, $01, $88, $06, $02, $40, $05, $02, $c0 ; $F402
...
_label_f40f:
  ...
  ldx #$00                       ; $F417  A2 00
  lda #$23                       ; $F419  A9 23
  sta _var_0612                  ; $F41B  8D 12 06
  lda #$2E                       ; $F41E  A9 2E
  sta _var_0610                  ; $F420  8D 10 06
  ...
  ldy <_var_00d0_indexed         ; $F434  A4 D0
  inc <_var_00d0_indexed         ; $F436  E6 D0
...
_label_f448:
  ldy <_var_00e9                 ; $F448  A4 E9

_label_f44a:
  sty APU_PL1_VOL                ; $F44A  8C 00 40
  lda <_var_00dc_indexed         ; $F44D  A5 DC
  sta <_var_00d8                 ; $F44F  85 D8
...
_label_f47e:
  ...
  ldx #$02                       ; $F486  A2 02
  lda #$9B                       ; $F488  A9 9B
  sta _var_0610                  ; $F48A  8D 10 06
  lda #$92                       ; $F48D  A9 92
  sta _var_0612                  ; $F48F  8D 12 06
  ldy <_var_00d2                 ; $F492  A4 D2
  inc <_var_00d2                 ; $F494  E6 D2
  lda [_var_00fc_indexed],Y      ; $F496  B1 FC
  jmp _label_f51c                ; $F498  4C 1C F5
  tya                            ; $F49B  98
  bpl _label_f4bf                ; $F49C  10 21
  jsr _func_f544                 ; $F49E  20 44 F5
  ldy <_var_00e4                 ; $F4A1  A4 E4
...
_label_f4b4:
  ...
  sta <_var_00e7                 ; $F4B7  85 E7
  ldy <_var_00d2                 ; $F4B9  A4 D2
  inc <_var_00d2                 ; $F4BB  E6 D2
...
_label_f4c8:
  ldy <_var_00e7                 ; $F4C8  A4 E7

_label_f4ca:
  sty APU_TRI_LINEAR             ; $F4CA  8C 08 40
  lda <$DE                       ; $F4CD  A5 DE
  sta <_var_00da                 ; $F4CF  85 DA
...
_label_f4d1:
  ...
  ldx #$03                       ; $F4D9  A2 03
  lda #$EE                       ; $F4DB  A9 EE
  sta _var_0610                  ; $F4DD  8D 10 06
  lda #$E5                       ; $F4E0  A9 E5
  sta _var_0612                  ; $F4E2  8D 12 06
  ...
  ldy <_var_00d3                 ; $F4F4  A4 D3
  inc <_var_00d3                 ; $F4F6  E6 D3
  lda [_var_00fe_indexed],Y      ; $F4F8  B1 FE

_label_f4fa:
  jsr _func_f502                 ; $F4FA  20 02 F5
  lda <$DF                       ; $F4FD  A5 DF
  sta <_var_00db                 ; $F4FF  85 DB
...
_func_f502:
  tay                            ; $F502  A8
  lda <_var_00f3                 ; $F503  A5 F3
  cmp #$02                       ; $F505  C9 02
  beq _label_f51b                ; $F507  F0 12
  lda _data_f400_indexed,Y       ; $F509  B9 00 F4
  sta APU_NOISE_VOL              ; $F50C  8D 0C 40
  lda _data_f401_indexed,Y       ; $F50F  B9 01 F4
  sta APU_NOISE_LO               ; $F512  8D 0E 40
  lda _data_f402_indexed,Y       ; $F515  B9 02 F4
...
_func_f544:
  ...
  tay                            ; $F549  A8
  lda _data_f350_indexed,Y       ; $F54A  B9 50 F3
...
_label_f552:
  tay                            ; $F552  A8
  lda _data_f301_indexed,Y       ; $F553  B9 01 F3
  beq _label_f563                ; $F556  F0 0B
  sta APU_PL1_LO,X               ; $F558  9D 02 40
  lda _data_f300_indexed,Y       ; $F55B  B9 00 F3
  ora #$08                       ; $F55E  09 08
...
_func_f581:
  lda #$F4                       ; $F581  A9 F4
  sta $0613                      ; $F583  8D 13 06
  sta $0611                      ; $F586  8D 11 06
  rts                            ; $F589  60
...
_label_f5fb:
  ...
  lda _data_f3e1_indexed,Y       ; $F604  B9 E1 F3
...
_label_f6b4:
  ...
  lda _data_f6cb_indexed,Y       ; $F6B6  B9 CB F6
...
_label_f703:
  ...
  lda _data_f731_indexed,Y       ; $F711  B9 31 F7
  sta APU_NOISE_LO               ; $F714  8D 0E 40
  lda _data_f761_indexed,Y       ; $F717  B9 61 F7
...
_data_f847_indexed:
 .byte $13, $1c                  ; $F847  13 1C  disambiguous instruction: slo [$001C],Y

_data_f849_indexed:
  and <$2E                       ; $F849  25 2E

_data_f84b_indexed:
 .byte $37, $40                  ; $F84B  37 40  disambiguous instruction: rla <$40,X

_data_f84d_indexed:
  eor #$52                       ; $F84D  49 52
 .byte $5b, $07, $c3             ; $F84F  5B 07 C3  disambiguous instruction: sre $C307,Y
  sed                            ; $F852  F8
 .byte $e2, $f8                  ; $F853  E2 F8  disambiguous instruction: nop #$F8
  php                            ; $F855  08
  sbc _data_f91b_indexed,Y       ; $F856  F9 1B F9
 .byte $07, $2f                  ; $F859  07 2F  disambiguous instruction: slo <$2F
  sbc _data_f960_indexed,Y       ; $F85B  F9 60 F9
  lda [_var_00f9_indexed,X]      ; $F85E  A1 F9
  cpy $07F9                      ; $F860  CC F9 07
 .byte $af, $fa, $ca             ; $F863  AF FA CA  disambiguous instruction: lax $CAFA
 .byte $fa                       ; $F866  FA  disambiguous instruction: nop
  cpx <_var_00fa_indexed         ; $F867  E4 FA
  sbc <_var_00fa_indexed,X       ; $F869  F5 FA
 .byte $07, $da                  ; $F86B  07 DA  disambiguous instruction: slo <$DA
  sbc _data_f9f7_indexed,Y       ; $F86D  F9 F7 F9
 .byte $13, $fa                  ; $F870  13 FA  disambiguous instruction: slo [$00FA],Y
  plp                            ; $F872  28
 .byte $fa                       ; $F873  FA  disambiguous instruction: nop
 .byte $07, $2f                  ; $F874  07 2F  disambiguous instruction: slo <$2F
 .byte $fa                       ; $F876  FA  disambiguous instruction: nop
 .byte $3f, $fa, $64             ; $F877  3F FA 64  disambiguous instruction: rla $64FA,X
 .byte $fa                       ; $F87A  FA  disambiguous instruction: nop
 .byte $80, $fa                  ; $F87B  80 FA  disambiguous instruction: nop #$FA
 .byte $07, $91                  ; $F87D  07 91  disambiguous instruction: slo <$91
 .byte $fa                       ; $F87F  FA  disambiguous instruction: nop
  txs                            ; $F880  9A
 .byte $fa                       ; $F881  FA  disambiguous instruction: nop
 .byte $a7, $fa                  ; $F882  A7 FA  disambiguous instruction: lax <$FA
  brk                            ; $F884  00
  brk                            ; $F885  00
 .byte $07, $bd                  ; $F886  07 BD  disambiguous instruction: slo <$BD
  sed                            ; $F888  F8
  brk                            ; $F889  00
  brk                            ; $F88A  00
  brk                            ; $F88B  00
  ...
  rol a                          ; $F892  2A
  sbc _var_0000_indexed,Y        ; $F893  F9 00 00
  brk                            ; $F896  00
  brk                            ; $F897  00
  brk                            ; $F898  00
  tax                            ; $F899  AA
 ...
 .byte $b7, $f8                  ; $F89D  B7 F8  disambiguous instruction: lax <$F8,Y
  brk                            ; $F89F  00
  brk                            ; $F8A0  00
  brk                            ; $F8A1  00
  brk                            ; $F8A2  00
 .byte $ff, $18, $ff             ; $F8A3  FF 18 FF  disambiguous instruction: isc $FF18,X
  brk                            ; $F8A6  00
  brk                            ; $F8A7  00
  brk                            ; $F8A8  00
  brk                            ; $F8A9  00
 ...
 .byte $3c, $3a, $38             ; $F8AC  3C 3A 38  disambiguous instruction: nop $383A,X
  ...
  sta <_var_0044_indexed         ; $F8B1  85 44
