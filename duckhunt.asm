;------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
;DUCK HUNT (WORLD).NES DISASSEMBLY
;BY HTMLCODER2023
;THIS FILE IS PROVIDED UNDER THE MIT LICENSE.
;A DUMP OF THE 8KB CHR-ROM FILE IS REQUIRED FOR THIS TO WORK.
;FILE GENERATED BY NESGODISASM
;------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
;SPECIAL THANKS
;1. To the creators of the RAM Map of Duck Hunt at https://datacrystal.tcrf.net/wiki/Duck_Hunt/RAM_map, for figuring out some labels in the game
;2. To ItzSwirlz at https://github.com/ItzSwirlz/DuckHuntDisassembly, for figuring out some labels in the game
;3. To cornelk at https://github.com/retroenv/nesgodisasm, for creating an easy-to-use disassembler that works
;4. To the creators of FCEUX at https://fceux.com/web/home.html, for creating an emulator that makes reverse-engineering significantly easier
;5. And finally, to the creators of the NESDEV community. Their documentation not only makes reverse-engineering much easier, but also makes creating emulators much easier.
;------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
_func_c263:
  ldy <whiteBoxDisplay                 ; $C263  A4 27
  beq _label_c262                ; $C265  F0 FB
  ldy #$00                       ; $C267  A0 00
  sty <whiteBoxDisplay                 ; $C269  84 27
  lda #$00                       ; $C26B  A9 00
  ldx #$04                       ; $C26D  A2 04
...
_label_c5fb:
  lda target1Type,Y        ; $C5FB  B9 00 03
...
_label_c60b:
  ...
  sta target1Type,Y        ; $C60D  99 00 03
  iny                            ; $C610  C8
  inx                            ; $C611  E8
  cpx #$50                       ; $C612  E0 50
...
_label_c63a:
  sta target1Type,Y        ; $C63A  99 00 03
  iny                            ; $C63D  C8
...
_label_cdd9:
  ...
  lda #$01                       ; $CE0B  A9 01
  sta <whiteBoxDisplay                 ; $CE0D  85 27
  lda #$12                       ; $CE0F  A9 12
...
_func_cf96:
  ...
  lda #$01                       ; $CFA7  A9 01
  sta <whiteBoxDisplay                 ; $CFA9  85 27
  lda #$36                       ; $CFAB  A9 36
  sta BGColor          ; $CFAD  8D 03 04
...
_label_d169:
  ...
  lda <shotsRemaining                 ; $D16D  A5 BA
  beq _label_d164                ; $D16F  F0 F3
  dec <shotsRemaining                 ; $D171  C6 BA
  lda #$01                       ; $D173  A9 01
...
_label_d19f:
  ...
  ldy #$00                       ; $D1A7  A0 00
  lda target1Type          ; $D1A9  AD 00 03
  beq _label_d1b5                ; $D1AC  F0 07
  lda target1State          ; $D1AE  AD 01 03
  cmp #$03                       ; $D1B1  C9 03
...
_label_d1e6:
  ...
  ldy #$01                       ; $D1ED  A0 01
  sty <whiteBoxDisplay                 ; $D1EF  84 27
...
_label_d246:
  ...
  stx target1State          ; $D250  8E 01 03
...
_label_d259:
  ...
  ldy #$01                       ; $D25F  A0 01
  sty <whiteBoxDisplay                 ; $D261  84 27
  iny                            ; $D263  C8
...
_func_d292:
  lda target1Y,Y        ; $D292  B9 02 03
  sta <_var_00b1                 ; $D295  85 B1
  lda target1X,Y        ; $D297  B9 03 03
...
_func_d3d2:
  lda <whiteBoxDisplay                 ; $D3D2  A5 27
...
_func_d3df:
  lda target1Type,Y        ; $D3DF  B9 00 03
  beq _label_d427                ; $D3E2  F0 43
  lda target1State,Y        ; $D3E4  B9 01 03
  cmp #$03                       ; $D3E7  C9 03
